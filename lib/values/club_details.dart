...
class ClubDetails{
  ...
  ClubDetails(){
    ...
    map[_name.ipatinga] = [ClubColors(Colors.green,Colors.red),Coordinates(-19.470869944552266, -42.541159),
    ...
    map[_name.ituano] = [ClubColors(Colors.red,Colors.black),Coordinates(-23.2803369, -47.287407673976766),
