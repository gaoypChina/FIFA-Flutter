...
class ClubDetails{
  ...
  ClubDetails(){
    ...
    mapDetails[_name.sheffieldunited] = [ClubColors(Colors.red,Colors.black),Coordinates(53.37055504286472, -1.4709732045853037),'Bramall Lane',39859,1889,[_name.sheffieldWednesday]];
    ...
    mapDetails[_name.barnsley] = [ClubColors(Colors.red,Colors.white),Coordinates(53.552222,-1.4675),'Oakwell Stadium',23000,1887,];
    mapDetails[_name.blackpool] = [ClubColors(Colors.orange,Colors.white),Coordinates(53.804722,-3.048056),'Bloomfield Road',12555,1887,];
    mapDetails[_name.bradford] = [ClubColors(Colors.orangeAccent,Colors.red),Coordinates(53.804222222,-1.759022222),'Valley Parade',25136,1903,];
    mapDetails[_name.brentford] = [ClubColors(Colors.red,Colors.white),Coordinates(51.488167,-0.302639),'Griffin Park',17250,1889,];
    mapDetails[_name.bolton] = [ClubColors(Colors.white,darkblue),Coordinates(53.580555555,-2.535555555),'Reebok Stadium',28723,1874,];
    mapDetails[_name.bristol] = [ClubColors(Colors.red,Colors.white),Coordinates(51.44,-2.620278),'Ashton Gate Stadium',21497,1897,];
    mapDetails[_name.cardiffCity] = [ClubColors(Colors.blue,Colors.white),Coordinates(51.472778,-3.203056),'Cardiff City Stadium',33000,1899,];
    mapDetails[_name.coventry] = [ClubColors(Colors.yellow,Colors.black),Coordinates(52.44849844760388, -1.4962162660188947),'Coventry Building Society Arena',32609,1883,];
    mapDetails[_name.charlton] = [ClubColors(Colors.red,Colors.black),Coordinates(51.487489,0.035632),'The Valley',27116,1905,];
    mapDetails[_name.grimsby] = [ClubColors(Colors.white,Colors.black),Coordinates(0,0),'Blundell Park',9052,1878,];
    mapDetails[_name.huddersfield] = [ClubColors(Colors.blue,Colors.white),Coordinates(53.654166666,-1.768333333),'Kirklees Stadium',24500,1908,];
    mapDetails[_name.ipswichTown] = [ClubColors(Colors.blue,Colors.white),Coordinates(52.055067557529036, 1.1451992575230177),'Portman Road',30311,1878,];
    mapDetails[_name.luton] = [ClubColors(Colors.red,Colors.blue),Coordinates(51.88368823867562, -0.4305913598086313),'Kenilworth Road',10356,1885,];
    mapDetails[_name.millwall] = [ClubColors(Colors.blue,Colors.white),Coordinates(51.485833,-0.050833),'The New Den',20146,1885,];
    mapDetails[_name.notts] = [ClubColors(Colors.black,Colors.white),Coordinates(52.9425,-1.137222),'Meadow Lane',19841,1862,];
    mapDetails[_name.oxford] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(51.716419,-1.208067),'Oxford Stadium',30582,1893,];
    mapDetails[_name.peterborough] = [ClubColors(Colors.blue,Colors.blue),Coordinates(52.56483332338586, -0.24020425648551616),'Weston Homes Stadium',15314,1934,];
    mapDetails[_name.portsmouth] = [ClubColors(Colors.blue,Colors.white),Coordinates(50.796388888,-1.063888888),'Fratton Park',20688,1898,];
    mapDetails[_name.plymouth] = [ClubColors(Colors.green,Colors.black),Coordinates(50.388055555,-4.150833333),'Home Park',19500,1886,];
    mapDetails[_name.prestonNorthEnd] = [ClubColors(Colors.white,darkblue),Coordinates(53.772222222,-2.688055555),'Deepdale',23408,1880,];
    mapDetails[_name.rotherham] = [ClubColors(Colors.red,Colors.white),Coordinates(53.4279,-1.362),'New York Stadium',12021,1925,];
    mapDetails[_name.shrewsbury] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(52.68877061720966, -2.7490981164624073),'New Meadow',9875,1886,];
    mapDetails[_name.sheffieldWednesday] = [ClubColors(Colors.blue,Colors.white),Coordinates(53.411388888,-1.500555555),'Estádio Hillsborough',39732,1867,[_name.sheffieldunited]];
    mapDetails[_name.sunderland] = [ClubColors(Colors.red,Colors.white),Coordinates(54.9144,-1.3882),'Stadium of Light',49000,1879,[_name.newcastle]];
    mapDetails[_name.swindon] = [ClubColors(Colors.red,Colors.white),Coordinates(0,0),'County Ground',15728,1879,];
    mapDetails[_name.wigan] = [ClubColors(Colors.blue,Colors.white),Coordinates(53.547778,-2.653889),'DW Stadium',25135,1932,];
    mapDetails[_name.wimbledon] = [ClubColors(Colors.yellow,Colors.black),Coordinates(51.431363888,-0.186669444),'Plough Lane',9215,2002,];
    ...
    mapDetails[_name.milan] = [ClubColors(Colors.red,Colors.black),Coordinates(45.4786,9.1244),'Giuseppe Meazza',80018,1899,[_name.juventus,_name.inter]];
    ...
    mapDetails[_name.roma] = [ClubColors(Colors.deepOrange,Colors.red),Coordinates(41.9339,12.454),'Stadio Olimpico',73261,1900,[_name.lazio]];
    ...
    mapDetails[_name.sassuolo] = [ClubColors(Colors.green,Colors.black),Coordinates(44.714722,10.649722),'MAPEI Stadium',23717,1920,];
    ...
    mapDetails[_name.ascoli] = [ClubColors(Colors.white,Colors.black),Coordinates(42.861111,13.594167),'Stadio Cino e Lillo Del Duca',20000,1898,];
    mapDetails[_name.bari] = [ClubColors(Colors.white,Colors.red),Coordinates(41.084736,16.840072),'San Nicola',58270,1908,];
    mapDetails[_name.benevento] = [ClubColors(Colors.yellow,Colors.red),Coordinates(41.11669096853642, 14.781777381651445),'Municipal Stadium Ciro Vigorito',17554,1929,];
    ...
    mapDetails[_name.como] = [ClubColors(Colors.blue,Colors.white),Coordinates(45.81424754723032, 9.072349181538822),'Giuseppe Sinigaglia',13602,1907,];
    ...
    mapDetails[_name.crotone] = [ClubColors(Colors.red,Colors.blue),Coordinates(39.079167,17.116667),'Ezio Scida',16547,1923,];
    mapDetails[_name.empoli] = [ClubColors(Colors.blue,Colors.white),Coordinates(43.726389,10.955),'Carlo Castellanni',19847,1920,];
    mapDetails[_name.foggia] = [ClubColors(Colors.red,Colors.black),Coordinates(41.45503127086417, 15.542573073997119),'Pino Zaccheria',25085,1920,];
    mapDetails[_name.frosinone] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(41.634981139201074, 13.321672921060664),'Benito Stirpe',16227,1906,];
    ...
    mapDetails[_name.piacenza] = [ClubColors(Colors.red,Colors.white),Coordinates(45.02977717046176, 9.69040781777808),'Leonardo Garilli',21608,1919,];
    mapDetails[_name.perugia] = [ClubColors(Colors.red,Colors.white),Coordinates(43.106416208598745, 12.357417118353453),'Estádio Renato Curi',23625,1905,];
    ...
    mapDetails[_name.reggina] = [ClubColors(grena,Colors.white),Coordinates(38.09282370807243, 15.635732713372386),'Stadio Oreste',27763,1914,];
    ...
    mapDetails[_name.valencia] = [ClubColors(Colors.white,Colors.orange),Coordinates(39.474722,-0.358333),'Mestalla',48600,1919,];
    mapDetails[_name.villareal] = [ClubColors(Colors.yellow,Colors.yellow),Coordinates(39.944167,-0.103611),'La Cerámica',23500,1923,];

    mapDetails[_name.alaves] = [ClubColors(Colors.blue,Colors.white),Coordinates(42.837224, -2.68794204),'Mendizorroza',19840,1921,];
    mapDetails[_name.albacete] = [ClubColors(Colors.white,Colors.white),Coordinates(38.981201108390465, -1.8516267370025241),'Carlos Belmonte',17300,1940,];
    ...
    mapDetails[_name.barcelonaB] = [ClubColors(grena,Colors.blue),Coordinates(41.37443652, 2.050680580),'Estadi Johan Cruyff',6000,1970,];
    mapDetails[_name.badajoz] = [ClubColors(Colors.white,Colors.black),Coordinates(38.85909805058098, -7.005712641258505),'Nuevo Vivero',14898,1905,];
    mapDetails[_name.burgos] = [ClubColors(Colors.white,Colors.black),Coordinates(42.34445896760816, -3.6803115846755574),'Estádio Municipal de El Plantío',12200,1994,];
    mapDetails[_name.cadiz] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(36.50274029685163, -6.272703671625995),'Estadio Ramón de Carranza',20724,1910,];
    mapDetails[_name.cartagena] = [ClubColors(Colors.white,Colors.black),Coordinates(37.60997607308336, -0.9961850276088828),'Estádio Cartagonova',15105,1995,];
    mapDetails[_name.compostela] = [ClubColors(Colors.blue,Colors.white),Coordinates(42.88266375966114, -8.51672248511444),'Vero Boquete',13000,1962,];
    ...
    mapDetails[_name.eibar] = [ClubColors(Colors.blue,Colors.red),Coordinates(43.18193713680332, -2.47563195763621),'Municipal de Ipurua',8164,1940,];
    mapDetails[_name.elche] = [ClubColors(Colors.white,Colors.green),Coordinates(38.266944,-0.663333),'Martínez Valero',36017,1922,];
    mapDetails[_name.extremadura] = [ClubColors(Colors.red,Colors.blue),Coordinates(0,0),'Francisco de la Hera',11580,1924,];
    mapDetails[_name.girona] = [ClubColors(Colors.red,Colors.white),Coordinates(41.961560623544194, 2.8289012665501416),'Estádio Montilivi',13500,1930,];
    mapDetails[_name.tarragona] = [ClubColors(Colors.red,Colors.white),Coordinates(42.19020152864727, 2.4763709658248683),'Nou Estadi',14500,1886,];
    mapDetails[_name.granada] = [ClubColors(Colors.red,Colors.white),Coordinates(37.152967,-3.595736),'Nuevo Los Cármenes',22524,1931,];
    mapDetails[_name.hercules] = [ClubColors(Colors.blue,Colors.white),Coordinates(38.35806250426043, -0.4914326032648159),'José Rico Pérez',29500,1922,];
    mapDetails[_name.huelva] = [ClubColors(Colors.white,Colors.blue),Coordinates(37.24660814, -6.9540283),'Estadio Nuevo Colombino',21670,1889,];
    mapDetails[_name.huesca] = [ClubColors(Colors.blue,Colors.red),Coordinates(42.131944,-0.424444),'Estádio El Alcoraz',8000,1960,];
    mapDetails[_name.ibiza] = [ClubColors(Colors.blue,Colors.white),Coordinates(38.913791833, 1.415050),'Estádio Municipal de Can Misses',4500,2015,];
    ...
    mapDetails[_name.leganes] = [ClubColors(Colors.white,Colors.blue),Coordinates(40.34069357468791, -3.7602580613941674),'Municipal de Butarque',10958,1928,];
    ...
    mapDetails[_name.merida] = [ClubColors(Colors.white,Colors.black),Coordinates(38.91448460097904, -6.336490389883272),'Estadio Romano',14600,1912,];
    mapDetails[_name.murcia] = [ClubColors(Colors.red,Colors.white),Coordinates(38.04249942843141, -1.144061948739576),'Nueva Condomina',33900,1908,];
    ...
    mapDetails[_name.realmadridB] = [ClubColors(Colors.white,Colors.white),Coordinates(40.4770605354219, -3.6142376094313704),'Estádio Alfredo Di Stéfano',12000,1930,];
    mapDetails[_name.salamanca] = [ClubColors(Colors.white,Colors.red),Coordinates(40.99550031894454, -5.6647436453888655),'El Helmántico',17341,2013,];
    mapDetails[_name.sportingGijon] = [ClubColors(Colors.red,Colors.white),Coordinates(43.536111,-5.637222),'El Molinón',30000,1905,];
    ...
    mapDetails[_name.toledo] = [ClubColors(Colors.green,Colors.white),Coordinates(39.86914546764724, -4.0182605067083665),'Salto del Caballo',5500,1928,];
    mapDetails[_name.realOviedo] = [ClubColors(Colors.blue,Colors.white),Coordinates(43.36087515372579, -5.869790783374754),'Novo Estádio Carlos Tartiere',30500,1926,];
    mapDetails[_name.xerez] = [ClubColors(Colors.blue,Colors.white),Coordinates(36.6896000729543, -6.119811153994252),'Estadio de Chapín',20523,1947,];
    ...
    mapDetails[_name.aachen] = [ClubColors(Colors.yellow,Colors.black),Coordinates(50.793333333,6.097222222),'New Tivoli',32960,1900,];
    ...
    mapDetails[_name.darmstadt] = [ClubColors(Colors.blue,Colors.white),Coordinates(49.85781666103, 8.672877134887),'Merck-Stadion am Böllenfalltor',17000,1898,];
    mapDetails[_name.duisburg] = [ClubColors(Colors.blue,Colors.white),Coordinates(51.409028,6.778639),'MSV-Arena',31500,1902,];
    ...
    mapDetails[_name.erzgebirgeaue] = [ClubColors(Colors.purple,Colors.black),Coordinates(50.5975,12.711111),'Erzgebirgsstadion',15711,1946,];
    mapDetails[_name.energieCottbus] = [ClubColors(Colors.white,Colors.red),Coordinates(51.751389,14.345556),'Stadion der Freundschaft',25450,1966,];
    mapDetails[_name.eintrachtBraunschweiger] = [ClubColors(Colors.white,Colors.blue),Coordinates(52.29,10.521389),'Eintracht-Stadion',23325,1895,];
    mapDetails[_name.fortunaDusseldorf] = [ClubColors(Colors.red,Colors.white),Coordinates(51.261539,6.733083),'Merkur Spielarena',54600,1895,];
    ...
    mapDetails[_name.hansaRostock] = [ClubColors(Colors.blue,Colors.white),Coordinates(54.08495,12.095188888),'Ostseestadion',29000,1965,];
    mapDetails[_name.greutherFurth] = [ClubColors(Colors.green,Colors.white),Coordinates(49.487076246317095, 11.000017098796395),'Stadion am Laubenweg',15500,1903];
    ...
    mapDetails[_name.magdeburg] = [ClubColors(Colors.blue,Colors.white),Coordinates(52.12540760351741, 11.670571043503788),'MDCC-Arena',30098,1965,];
    ...
    mapDetails[_name.uerdigen] = [ClubColors(Colors.red,Colors.blue),Coordinates(51.339167,6.603611),'Grotenburg-Stadion',34500,1905,];
    mapDetails[_name.rotWeissEssen] = [ClubColors(Colors.white,Colors.red),Coordinates(51.48677580723364, 6.976799022881835),'Georg-Melches-Stadion',22500,1907,];
    mapDetails[_name.saarbrucken] = [ClubColors(Colors.blue,Colors.black),Coordinates(49.2475,6.984167),'Ludwigsparkstadion',16003,1903,];
    ...
    mapDetails[_name.angers] = [ClubColors(Colors.white,Colors.black),Coordinates(47.460623285494066, -0.5314198073077759),'Stade Jean-Bouin',18752,1919,];
    ...
    mapDetails[_name.brest] = [ClubColors(Colors.red,Colors.white),Coordinates(48.402932,-4.461694),'Stade Francis-Le Blé',15000,1950,];
    mapDetails[_name.caen] = [ClubColors(Colors.red,Colors.blue),Coordinates(49.17955727851539, -0.3960763935464237),'Michel d\'Ornano',21500,1913,];
    ...
    mapDetails[_name.dijon] = [ClubColors(Colors.red,Colors.white),Coordinates(47.32493401383849, 5.068403775093125),'Stade Gaston-Gérard',16000,1998,];
    mapDetails[_name.guingamp] = [ClubColors(Colors.red,Colors.black),Coordinates(48.565492846592825, -3.1643878327483543),'Stade du Roudourou',18256,1912,];
    ...
    mapDetails[_name.nimes] = [ClubColors(Colors.red,Colors.white),Coordinates(43.81613586835348, 4.359880279238953),'Stade des Costières',18482,1937,[_name.montpellier]];
    ...
    mapDetails[_name.rouen] = [ClubColors(Colors.red,Colors.black),Coordinates(49.41143361097126, 1.070693944843452),'Stade Robert Diochon',12018,1899,];
    mapDetails[_name.sedan] = [ClubColors(Colors.green,Colors.red),Coordinates(49.69404732203414, 4.938800956160281),'Stade Louis Dugauguez',23189,1919,];
    ...
    mapDetails[_name.chaves] = [ClubColors(Colors.blue,Colors.red),Coordinates(41.750948861113564, -7.464533445112992),'	Estádio Municipal de Chaves',9000,1949,];
    ...
    mapDetails[_name.estrelaamadora] = [ClubColors(Colors.red,Colors.green),Coordinates(38.752164768925276, -9.227266112379061),'Estádio José Gomes',9288,1932,];
    ...
    mapDetails[_name.farense] = [ClubColors(Colors.white,Colors.black),Coordinates(37.022328114893085, -7.928202608333228),'Estádio de São Luís',7000,1910,];
    ...
    mapDetails[_name.leixoes] = [ClubColors(Colors.white,Colors.red),Coordinates(41.1842451364265, -8.666396418466357),'Estádio do Mar',9821,1907,];
    ...
    mapDetails[_name.moreirense] = [ClubColors(Colors.green,Colors.white),Coordinates(41.37820476039625, -8.354246900622611),'Comendador Joaquim de Almeida Freitas',6153,1938,];
    ...
    mapDetails[_name.pacosDeFerreira] = [ClubColors(Colors.yellow,Colors.green),Coordinates(41.271446682366985, -8.384887813773972),'Capital do Móvel',9077,1950,];
    ...
    mapDetails[_name.olhanense] = [ClubColors(Colors.red,Colors.black),Coordinates(37.02937056542217, -7.848373130442676),'Estádio José Arcanjo',10080,1912,];
    mapDetails[_name.rioAve] = [ClubColors(Colors.green,Colors.white),Coordinates(41.36282573110833, -8.739653212718668),'Estádio dos Arcos',5000,1939,];
    mapDetails[_name.salgueiros] = [ClubColors(Colors.red,Colors.white),Coordinates(41.15904746475558, -8.572435608280456),'Complexo Desportivo de Campanhã',1500,1911,];
    mapDetails[_name.santaClara] = [ClubColors(Colors.red,Colors.white),Coordinates(37.76392847557282, -25.622288584700296),'Estádio de São Miguel',10000,1927,];
    mapDetails[_name.uniaoLeiria] = [ClubColors(Colors.white,Colors.white),Coordinates(39.74945449173086, -8.812609974276361),'Estádio Dr. Magalhães Pessoa',125000,1966,];
    mapDetails[_name.tondela] = [ClubColors(Colors.green,Colors.yellow),Coordinates(40.51203795619266, -8.082878165507793),'Estádio João Cardoso',5000,1933,];
    mapDetails[_name.viseu] = [ClubColors(Colors.black,Colors.white),Coordinates(40.65955321602642, -7.900396978887168),'Estádio do Fontelo',6912,1914,];
    mapDetails[_name.vizela] = [ClubColors(Colors.white,Colors.blue),Coordinates(41.38882478623334, -8.306887911413858),'Estádio do Futebol Clube de Vizela',6000,1939,];
    ...
    mapDetails[_name.heerenveen] = [ClubColors(Colors.blue,Colors.white),Coordinates(52.9588594880557, 5.936259769861008),'Abe Lenstra',26100,1920,];
    mapDetails[_name.spartarotterdam] = [ClubColors(Colors.red,Colors.white),Coordinates(51.92002413159479, 4.433776185185383),'Sparta Stadion Het Kasteel',11026,1888,];
    mapDetails[_name.willem] = [ClubColors(Colors.blue,Colors.red),Coordinates(51.54301953859648, 5.067781658922021),'Willen II Stadion',45500,1896,];
    ...
    mapDetails[_name.gent] = [ClubColors(Colors.blue,Colors.white),Coordinates(51.01671567515562, 3.7347187609123194),'Ghelamco Arena',20000,1900,];
    mapDetails[_name.lierse] = [ClubColors(Colors.yellow,Colors.black),Coordinates(51.144333497109585, 4.57393474070042),'Herman Vanderpoorten Stadion',15500,1906,];
    mapDetails[_name.royalAntwerp] = [ClubColors(Colors.red,Colors.white),Coordinates(51.23260015472852, 4.472522635773205),'Stadium “BOSUIL“',10000,1880,];
    mapDetails[_name.mechelen] = [ClubColors(Colors.red,Colors.yellow),Coordinates(51.03687065526583, 4.487291537988871),'AFAS Stadion',10000,1904,];
    mapDetails[_name.charleroi] = [ClubColors(Colors.white,Colors.black),Coordinates(50.41487489997499, 4.453183668882974),'Stade du Pays de Charleroi',25000,1904,];
    mapDetails[_name.beveren] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(51.21436504721321, 4.244221247543427),'Freethiel Stadion',13290,1936,];
    ...
    mapDetails[_name.aberdeen] = [ClubColors(Colors.red,Colors.white),Coordinates(57.159861789437294, -2.088085376186921),'Pittodrie Stadium',22199,1903,];
    mapDetails[_name.dundee] = [ClubColors(Colors.orange,Colors.black),Coordinates(56.4748207062714, -2.968603106135804),'Tannadice Park',14209,1909,];
    ...
    mapDetails[_name.kilmarnock] = [ClubColors(Colors.blue,Colors.black),Coordinates(55.604225,-4.508122),'Rugby Park',18128,1869,];
    //IRLANDA DO NORTE GALES
    mapDetails[_name.linfield] = [ClubColors(Colors.blue,Colors.white),Coordinates(54.582700483277314, -5.954806801881155),'Windsor Park',21000,1886,];
    mapDetails[_name.glentoran] = [ClubColors(Colors.green,Colors.red),Coordinates(51.48389007836147, -0.1146840139686766),'The Oval',26556,1882,];
    mapDetails[_name.newsaints] = [ClubColors(Colors.green,Colors.blue),Coordinates(52.8759,-3.02631),'Park Hall',2034,1896,];
    //IRLANDA
    ...
    mapDetails[_name.cork] = [ClubColors(Colors.green,Colors.white),Coordinates(51.885517701229794, -8.468353748635607),'Turner Cross',7000,1984,];
    mapDetails[_name.derry] = [ClubColors(Colors.red,Colors.white),Coordinates(54.990852621806944, -7.336110758450032),'Brandywell',7700,1928,];
    mapDetails[_name.dundalk] = [ClubColors(Colors.white,Colors.black),Coordinates(53.99921346123983, -6.415993491759424),'Oriel Park',13600,1919,];
    mapDetails[_name.shamrock] = [ClubColors(Colors.green,Colors.white),Coordinates(53.28363777169359, -6.373458012215909),'Estádio de Tallaght',6000,1899,];

    //NORDICOS
    //NORUEGA
    mapDetails[_name.fredrikstad] = [ClubColors(Colors.red,Colors.white),Coordinates(59.21162675932621, 10.93747001118653),'Nye Fredrikstad Stadion',13300,1903,];
    mapDetails[_name.glimt] = [ClubColors(Colors.yellow,Colors.black),Coordinates(67.27666691868009, 14.384742457176511),'Aspmyra Stadion',7354,1916,];
    ...
    mapDetails[_name.valerenga] = [ClubColors(Colors.blue,Colors.white),Coordinates(59.94925250486655, 10.73449506268394),'Ullevaal Stadion',25000,1913,];
    //SUECIA
    ...
    //DINAMARCA
    mapDetails[_name.copenhague] = [ClubColors(Colors.white,Colors.blue),Coordinates(55.702801493878425, 12.572584226298794),'Parken Stadium',42358,1992,];
    mapDetails[_name.midtjylland] = [ClubColors(Colors.black,Colors.red),Coordinates(56.117084943757675, 8.952439451278998),'MCH Arena',11800,1999,];
    mapDetails[_name.brondby] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(55.64892327650882, 12.417979390429544),'Brøndby Stadion',29000,1964,];
    mapDetails[_name.randers] = [ClubColors(Colors.white,Colors.blue),Coordinates(56.46572077485179, 10.009500677727642),'AutoC Park Randers',10300,2003,];
    mapDetails[_name.obodense] = [ClubColors(Colors.white,Colors.blue),Coordinates(55.39794088243304, 10.350535478742769),'TRE-FOR Park',15761,1887,];
    mapDetails[_name.lyngby] = [ClubColors(Colors.blue,Colors.white),Coordinates(55.78079102321677, 12.50617005734735),'Lyngby Stadion',12000,1921,];
    mapDetails[_name.aalborg] = [ClubColors(Colors.red,Colors.white),Coordinates(57.052210568355, 9.899045278578187),'Estádio Aalborg',13800,1885,];
    ...
    mapDetails[_name.nordsjaelland] = [ClubColors(Colors.red,Colors.yellow),Coordinates(55.81610534417498, 12.352498875054323),'Farum Park',10000,1991,];
    mapDetails[_name.esbjerg] = [ClubColors(Colors.red,Colors.black),Coordinates(55.48228994837166, 8.439832057459824),'Blue Water Arena',18000,1924,];
    ...
    //FINLANDIA
    mapDetails[_name.helsinki] = [ClubColors(Colors.blue,Colors.white),Coordinates(60.187631525241386, 24.9233445914813),'Bolt Arena',10770,1907,];
    mapDetails[_name.haka] = [ClubColors(Colors.white,Colors.black),Coordinates(61.26808062242725, 24.02085023428088),'Tehtaan kenttä',6400,1934,];
    ...
    //ISLANDIA
    mapDetails[_name.akraness] = [ClubColors(Colors.yellow,Colors.black),Coordinates(64.31819030288712, -22.057136641306297),'Akranesvöllur',6000,1946,];
    mapDetails[_name.valur] = [ClubColors(Colors.red,Colors.white),Coordinates(64.13294129158774, -21.922968096546022),'Vodafonevöllurinn',3000,1911,];
    mapDetails[_name.hafnarfjardar] = [ClubColors(Colors.white,Colors.black),Coordinates(64.07608583455675, -21.935295742073322),'Kaplakriki',6450,1928,];
    ...
    mapDetails[_name.sturmGraz] = [ClubColors(Colors.black,Colors.white),Coordinates(47.04664567173094, 15.455268492776918),'Merkur Arena',16400,1909,];
    mapDetails[_name.austria] = [ClubColors(Colors.purple,Colors.white),Coordinates(48.16250323169553, 16.387632263981203),'Franz Horr',17656,1911,];
    ...
    mapDetails[_name.zurich] = [ClubColors(Colors.blue,Colors.white),Coordinates(47.38279,8.503801),'Letzigrund',26500,1896,];
    mapDetails[_name.grasshoppers] = [ClubColors(Colors.blue,Colors.white),Coordinates(47.38286, 8.5036),'Letzigrund',26500,1886,];
    mapDetails[_name.sion] = [ClubColors(Colors.red,Colors.white),Coordinates(46.233536282465536, 7.376404736355037),'Estádio Tourbillon',14500,1909,];
    mapDetails[_name.servette] = [ClubColors(grena,Colors.white),Coordinates(46.177778,6.1275),'Stade de Genève',30084,1890,];
    mapDetails[_name.thun] = [ClubColors(Colors.red,Colors.white),Coordinates(46.74390559123201, 7.606633229549598),'Stockhorn Arena',10300,1898,];
    mapDetails[_name.neuchatel] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),'Stade de la Maladière',12000,1970,]; //FALIU
    mapDetails[_name.chauxdefonds] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(47.112810878543364, 6.8375679316335995),'Centre Sportif de la Charrière',12700,1894,];
    //POLONIA
    mapDetails[_name.gornik] = [ClubColors(Colors.white,Colors.black),Coordinates(50.296646268479854, 18.76963765376737),'Estádio Ernest Pohl',24563,1948,];
    mapDetails[_name.gwardia] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.legiaWarszawa] = [ClubColors(Colors.green,Colors.white),Coordinates(52.22057926406805, 21.04088559869264),'Pepsi Arena',31000,1916,];
    mapDetails[_name.lechPoznan] = [ClubColors(Colors.blue,Colors.white),Coordinates(52.397751830308636, 16.858715952507303),'Estádio Municipal de Poznań',41609,1922,];
    mapDetails[_name.ruchchorzow] = [ClubColors(Colors.blue,Colors.white),Coordinates(50.28228733849798, 18.945276380028233),'Stadion Ruchu Chorzów',9300,1920,];
    ...
    mapDetails[_name.wisla] = [ClubColors(Colors.red,Colors.white),Coordinates(50.06384019955333, 19.911990725893965),'Estádio Henryk Reyman',33326,1906,];
    ...
    mapDetails[_name.trabzonspor] = [ClubColors(Colors.red,Colors.blue),Coordinates(39.6463,40.9987),'Şenol Güneş Stadium',41461,1967,];
    mapDetails[_name.instanbul] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.adanaspor] = [ClubColors(Colors.orange,Colors.black),Coordinates(37.063725539285606, 35.37545482106474),'Novo Estádio de Adana',33543,1954,];
    mapDetails[_name.antalyaspor] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.denizlispor] = [ClubColors(Colors.green,Colors.black),Coordinates(37.76621146831148, 29.082656073088405),'Denizli Atatürk Stadyumu',18745,1966,];
    mapDetails[_name.goztepe] = [ClubColors(Colors.red,Colors.yellow),Coordinates(38.39559521318485, 27.076046407636582),'Estádio Gürsel Aksel',20035,1925,];
    ...
    mapDetails[_name.gaziantepspor] = [ClubColors(Colors.white,Colors.red),Coordinates(37.12306537693131, 37.38378410259563),'Estádio de Gaziantepe',35574,1988,];
    ...
    mapDetails[_name.sivasspor] = [ClubColors(Colors.red,Colors.white),Coordinates(39.724524244154836, 36.97510870631462),'Yeni Sivas 4 Eylül Stadı',27532,1967,];
    //GRECIA
    ...
    //CHIPRE
    mapDetails[_name.apoel] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(35.1145399234782, 33.363086967231894),'GSP Stadium',22859,1926,];
    mapDetails[_name.omonia] = [ClubColors(Colors.green,Colors.white),Coordinates(35.1145, 33.3631),'GSP Stadium',22859,1948,];
    ...
    //ISRAEL
    mapDetails[_name.maccabiTelAviv] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(32.05179174773427, 34.76178357396489),'Bloomfield Stadium',29400,1906,];
    mapDetails[_name.maccabiHaifa] = [ClubColors(Colors.green,Colors.black),Coordinates(32.78304797329524, 34.965858172817356),'Sammy Ofer',10000,1913,];
    mapDetails[_name.hapoelTelAviv] = [ClubColors(Colors.red,Colors.white),Coordinates(32.0518, 34.7618),'	Bloomfield Stadium',29400,1927,];
    ...
    mapDetails[_name.sochi] = [ClubColors(Colors.white,Colors.blue),Coordinates(43.401924994248006, 39.956279378120485),'Fisht',47659,2018,];
    mapDetails[_name.rubinKazan] = [ClubColors(Colors.green,Colors.red),Coordinates(55.821098392530416, 49.1610948692922),'Arena Kazan',45379,1958,];
    mapDetails[_name.rostov] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(47.20833333,39.74166667),'Rostov Arena',45000,1930,];
    mapDetails[_name.lokomotivMoscou] = [ClubColors(Colors.green,Colors.red),Coordinates(55.80355,37.741169),'Estádio Lokomotiv de Moscou',28800,1922,];
    mapDetails[_name.dinamoMoscou] = [ClubColors(Colors.blue,Colors.white),Coordinates(55.7909515602138, 37.5610590647535),'Dinamo Lev Yashin Stadium',36000,1923,];
    mapDetails[_name.anzhi] = [ClubColors(Colors.yellow,Colors.black),Coordinates(42.90790006811621, 47.618420756749046),'Arena Anji',10000,1991,];
    mapDetails[_name.kubanKrasnodar] = [ClubColors(Colors.green,Colors.yellow),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.rotor] = [ClubColors(Colors.blue,Colors.black),Coordinates(48.73463702343586, 44.54914292288772),'Volgograd Arena',45568,1929,];
    mapDetails[_name.torpedo] = [ClubColors(Colors.white,Colors.black),Coordinates(55.71643276656806, 37.65631509953889),'Eduard Streltsov',13400,1930,];
    mapDetails[_name.vladikavkaz] = [ClubColors(Colors.red,Colors.yellow),Coordinates(43.02330654874467, 44.695289689073626),'Republican Spartak Stadium',32464,1921,];
    //UCRANIA
    ...
    mapDetails[_name.dnipro] = [ClubColors(Colors.blue,Colors.white),Coordinates(0,0),'Dnipro Arena',31003,1918,]; //FALIU
    mapDetails[_name.zorya] = [ClubColors(Colors.black,Colors.white),Coordinates(47.85959971628591, 35.097371331583105),'Slavutych Arena',22888,1923,];
    mapDetails[_name.metalist] = [ClubColors(Colors.yellow,Colors.white),Coordinates(49.98100865464392, 36.26177324373913),'OSC Metalist',40003,1925,];
    //EX-URSS
    mapDetails[_name.sheriffTiraspol] = [ClubColors(Colors.black,Colors.yellow),Coordinates(46.83837744522103, 29.558221937838482),'Sheriff Stadium',12746,1997,];
    ...
    mapDetails[_name.qarabag] = [ClubColors(Colors.black,Colors.white),Coordinates(40.39740489689798, 49.85272464245199),'Estádio Tofig Bahramov',31200,1951,];
    mapDetails[_name.astana] = [ClubColors(Colors.white,Colors.blue),Coordinates(51.10838287814807, 71.4031747095404),'Astana Arena',30000,2009,];
    mapDetails[_name.tbilisi] = [ClubColors(Colors.white,Colors.blue),Coordinates(41.72,44.78),'Tbilisi Sports Palace',53279,1925,];
    mapDetails[_name.yerevan] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.zalgiris] = [ClubColors(Colors.green,Colors.greenAccent),Coordinates(54.66926441463891, 25.2951015305935),'LFF Stadium',5400,1947,];
    ...
    mapDetails[_name.vojvodina] = [ClubColors(Colors.red,Colors.white),Coordinates(45.246939989314725, 19.84175658419325),'Stadium of Vojvodina',15754,1914,];
    //BULGARIA
    mapDetails[_name.ludogorets] = [ClubColors(Colors.green,Colors.black),Coordinates(43.534406185, 26.528121692),'	Ludogorets Arena',12500,1940,];
    ...
    //CROATIA
    mapDetails[_name.dinamozagreb] = [ClubColors(Colors.red,Colors.blue),Coordinates(45.81867321710, 16.0181650412),'Maksimir',38923,1911,];
    mapDetails[_name.hadjuksplit] = [ClubColors(Colors.red,Colors.white),Coordinates(43.51984618230551, 16.432360984167556),'Polijud',35000,1911,];
    mapDetails[_name.rijeka] = [ClubColors(Colors.blue,Colors.white),Coordinates(45.347946972, 14.4026226413),'Kantrida',12600,1906,];
    //REP. TCHECA
    ...
    mapDetails[_name.ferencvaros] = [ClubColors(Colors.green,Colors.white),Coordinates(47.475396323123604, 19.0958287905669),'Gouprama Arena',22000,1899,];
    mapDetails[_name.gyori] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.honved] = [ClubColors(Colors.red,Colors.black),Coordinates(47.44256698406686, 19.155382225506823),'József Bozsik',15000,1909,];
    mapDetails[_name.mtk] = [ClubColors(Colors.blue,Colors.white),Coordinates(47.490919444,19.106725),'Hidegkuti Nándor Stadion',12700,1888,];
    mapDetails[_name.ujpest] = [ClubColors(Colors.purple,Colors.white),Coordinates(47.57500069899205, 19.085368422741304),'Ferenc Szusza',13600,1885,];
    mapDetails[_name.vasas] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),'Estádio',10000,1900,];
    //ROMENIA
    mapDetails[_name.steauaBucureste] = [ClubColors(Colors.red,Colors.blue),Coordinates(44.43741937450663, 26.153142180019834),'Arena Națională',55634,1947,];
    mapDetails[_name.dinamoBucureste] = [ClubColors(Colors.red,Colors.white),Coordinates(44.455083,26.102444),'Stadionul Dinamo',15300,1948,];
    mapDetails[_name.rapidBucureste] = [ClubColors(grena,Colors.white),Coordinates(44.45708788751633, 26.055645172166557),'Estádio Giulești-Valentin Stănescu',19100,1929,];
    mapDetails[_name.pitesti] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.cluj] = [ClubColors(Colors.red,Colors.white),Coordinates(46.779678,23.577247),'Stadionul Dr. Constantin Rădulescu',21000,1907,];
    ...
    //ESLOVAQUIA
    mapDetails[_name.slovanBratislava] = [ClubColors(Colors.blue,Colors.white),Coordinates(48.16596266838141, 17.142208986599012),'Pasienky',30085,1919,];
    ...
    mapDetails[_name.vardar] = [ClubColors(Colors.red,Colors.black),Coordinates(42.00609543518768, 21.42580392778437),'Nacional Arena Philip II Macedônia',24000,1947,];
    mapDetails[_name.sarajevo] = [ClubColors(grena,Colors.white),Coordinates(43.873918631077544, 18.40907842205062),'Estádio Asim Ferhatović Hase',35630,1946,];
    mapDetails[_name.tirana] = [ClubColors(Colors.blue,Colors.white),Coordinates(41.319020740064545, 19.811694611424013),'Selman Stermasi Stadium',7000,1920,];
    mapDetails[_name.dudelange] = [ClubColors(Colors.yellow,Colors.white),Coordinates(49.47303716840933, 6.085128060337294),'Jos Nosbaum',2558,1921,];
    mapDetails[_name.jeunesseesch] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),'Estádio',10000,1900,];    
    mapDetails[_name.sliema] = [ClubColors(Colors.blueAccent,Colors.blue),Coordinates(0,0),'Estádio Ta\' Qali',18000,1909,];
    ...
    mapDetails[_name.abc] = [ClubColors(Colors.white,Colors.black),Coordinates(-5.8884053612844065, -35.17937587272757),'Frasqueirão',18000,1915,];
    ...
    mapDetails[_name.americaRJ] = [ClubColors(Colors.red,Colors.white),Coordinates(-22.7953107, -43.41957718),'Estádio',10000,1900,];
    mapDetails[_name.americaRN] = [ClubColors(Colors.red,Colors.white),Coordinates(-5.93371016, -35.28271557468),'Arena América',5000,1915,];
    mapDetails[_name.anapolina] = [ClubColors(Colors.white,Colors.red),Coordinates(-16.345930, -48.95587463),'Jonas Duarte',20000,1948,];
    mapDetails[_name.botafogoPB] = [ClubColors(Colors.red,Colors.black),Coordinates(-7.1668181, -34.873362768627544),'Almeidão',19000,1931,];
    mapDetails[_name.botafogoSP] = [ClubColors(Colors.white,Colors.red),Coordinates(-21.201866, -47.78959753222946),'Estádio Santa Cruz',22292,1918,];
    mapDetails[_name.brasilia] = [ClubColors(Colors.red,Colors.white),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.brasiliense] = [ClubColors(Colors.yellow,Colors.white),Coordinates(-15.835889, -48.0801529),'Boca do Jacaré',27000,2000,[_name.gama]];
    mapDetails[_name.brasilPelotas] = [ClubColors(Colors.red,Colors.black),Coordinates(-31.7712377, -52.332841550319394),'Bento Freitas',10200,1911,];
    ...
    mapDetails[_name.central] = [ClubColors(Colors.white,Colors.black),Coordinates(-8.2785053, -35.972948033),'Lacerdão',20000,1919,];
    mapDetails[_name.comercial] = [ClubColors(Colors.white,Colors.black),Coordinates(-21.186531211629447, -47.788333),'Estádio Palma Travassos',18277,1911,];
    mapDetails[_name.confianca] = [ClubColors(Colors.blue,Colors.white),Coordinates(-10.894497556729105, -37.0538261),'Sabino Ribeiro',3000,1936,];
    mapDetails[_name.caxias] = [ClubColors(Colors.red,Colors.blue),Coordinates(-29.164952005642775, -51.1964163918332),'Centenário',30000,1935,];
    ...
    mapDetails[_name.gremioNovorizontino] = [ClubColors(Colors.yellow,Colors.black),Coordinates(-21.466885, -49.231995),'Estádio Jorge Ismael de Biasi',18000,1973,];
    mapDetails[_name.ferroviaria] = [ClubColors(grena,Colors.black),Coordinates(-21.7750702, -48.17012629935174),'Fonte Luminosa',20000,1950,];
    mapDetails[_name.gama] = [ClubColors(grena,Colors.white),Coordinates(-16.011271959253445, -48.06133544635439),'Bezerrão',20310,1975,[_name.brasiliense]];
    mapDetails[_name.goiania] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),'Estádio',10000,1900,];    
    mapDetails[_name.goytacaz] = [ClubColors(Colors.blue,Colors.white),Coordinates(-21.762024027957615, -41.31634627219756),'Ary de Oliveira e Souza',15000,1912,];
    ...
    mapDetails[_name.ipatinga] = [ClubColors(Colors.green,Colors.red),Coordinates(-19.470869944552266, -42.541159015158286),'Ipatingão',22000,1998,];
    ...
    mapDetails[_name.juventusMooca] = [ClubColors(grena,Colors.white),Coordinates(-23.553105198898812, -46.60451047969702),'Estádio Conde Rodolfo Crespi',5000,1924,];
    mapDetails[_name.londrina] = [ClubColors(Colors.blue,Colors.white),Coordinates(-23.282222,-51.165),'Estádio do Café',36000,1956,];
    mapDetails[_name.luverdense] = [ClubColors(Colors.green,Colors.white),Coordinates(-13.074398270380579, -55.92376224621404),'Passo das Emas',10000,2004,[_name.cuiaba]];
    mapDetails[_name.macae] = [ClubColors(Colors.red,Colors.black),Coordinates(-22.3563513, -41.77086),'Moacyrzão',15000,1990,];
    mapDetails[_name.madureira] = [ClubColors(Colors.purple,Colors.yellow),Coordinates(-22.869530143179063, -43.33703542589112),'Conselheiro Galvão',5014,1914,];
    mapDetails[_name.manaus] = [ClubColors(Colors.green,Colors.black),Coordinates(-3.082731444136859, -60.02706630528541),'Arena da Amazônia',44000,2013,];
    mapDetails[_name.mirassol] = [ClubColors(Colors.yellow,Colors.green),Coordinates(-20.821404501, -49.5065208),'	José Maria de Campos Maia',15000,1925,];
    mapDetails[_name.mixto] = [ClubColors(Colors.white,Colors.black),Coordinates(-15.60386, -56.1210),'Arena Pantanal',44097,1934,[_name.luverdense,_name.cuiaba]];
    mapDetails[_name.mogimirim] = [ClubColors(Colors.red,Colors.white),Coordinates(-22.43926392586487, -46.96171671069935),'Estádio Vail Chaves',19900,1932,];
    mapDetails[_name.motoclub] = [ClubColors(Colors.red,Colors.black),Coordinates(-2.5483, -44.2600),'Castelão',40149,1937,];
    mapDetails[_name.noroeste] = [ClubColors(Colors.red,Colors.white),Coordinates(-22.3242, -49.09748),'Alfredo de Castilho',18866,1910,];
    mapDetails[_name.novaiguacu] = [ClubColors(Colors.orange,Colors.black),Coordinates(-22.747857063112367, -43.46085192892773),'Jânio Moraes',4700,1990,];
    mapDetails[_name.oeste] = [ClubColors(Colors.red,Colors.black),Coordinates(-23.512235751662757, -46.89928345373255),'Arena Barueri',31452,1921,];
    mapDetails[_name.operarioms] = [ClubColors(Colors.white,Colors.black),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.operarioPR] = [ClubColors(Colors.black,Colors.white),Coordinates(-25.115991, -50.156180),'Germano Krüger',10632,1912,];
    mapDetails[_name.paysandu] = [ClubColors(Colors.blue,Colors.white),Coordinates(-1.381095, -48.44458),'Mangueirão',35000,1914,[_name.remo]];
    ...
    mapDetails[_name.remo] = [ClubColors(Colors.blue,Colors.white),Coordinates(-1.3811, -48.4447),'Mangueirão',35000,1905,[_name.paysandu]];
    mapDetails[_name.riverPI] = [ClubColors(Colors.red,Colors.black),Coordinates(-5.116047825, -42.792511),'Albertão',52216,1946,];
    ...
    mapDetails[_name.sampaio] = [ClubColors(Colors.yellow,Colors.red),Coordinates(-2.54823, -44.2599829),'Castelão',40149,1923,];
    mapDetails[_name.santoandre] = [ClubColors(Colors.white,Colors.blue),Coordinates(-23.669687, -46.50901102),'Estádio Bruno José Daniel',12000,1967,[_name.saocaetano]];
    mapDetails[_name.saobento] = [ClubColors(Colors.white,Colors.blue),Coordinates(-23.4902975, -47.44815),'Estádio Walter Ribeiro',13772,1913,];
    mapDetails[_name.saocaetano] = [ClubColors(Colors.blue,Colors.red),Coordinates(-23.630661, -46.56044844),'Anacleto Campanella',16744,1989,[_name.santoandre]];
    mapDetails[_name.saoraimundo] = [ClubColors(Colors.blue,Colors.white),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.sergipe] = [ClubColors(Colors.red,Colors.white),Coordinates(-10.92337996, -37.07210),'João Hora',6000,1909,];
    mapDetails[_name.tiradentes] = [ClubColors(Colors.red,Colors.white),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.tombense] = [ClubColors(Colors.red,Colors.white),Coordinates(-20.907664681440735, -42.030541527276654),'Antônio Guimarães de Almeida',3050,1914,];
    mapDetails[_name.treze] = [ClubColors(Colors.white,Colors.black),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.tunaluso] = [ClubColors(Colors.red,Colors.green),Coordinates(-1.381, -48.445),'Mangueirão',35000,1903,];
    mapDetails[_name.tupi] = [ClubColors(Colors.white,Colors.black),Coordinates(-21.787432790, -43.37794),'Mário Helênio',31863,1912,];
    mapDetails[_name.vilanova] = [ClubColors(Colors.red,Colors.white),Coordinates(-16.673543, -49.236922),'Onésio Brasileiro Alvarenga',11788,1943,];
    mapDetails[_name.voltaredonda] = [ClubColors(Colors.yellow,Colors.black),Coordinates(-22.5082739, -44.096673),'Raulino de Oliveira',20255,1976,];
    mapDetails[_name.xvpiracicaba] = [ClubColors(Colors.black,Colors.white),Coordinates(-22.7294362, -47.636847),'Barão de Serra Negra',18000,1913,];
    mapDetails[_name.xvjau] = [ClubColors(Colors.green,Colors.yellow),Coordinates(-22.296089, -48.57224110487209),'Zezinho Magalhães',12978,1924,];
    ...
    mapDetails[_name.arsenalsarandi] = [ClubColors(Colors.blue,Colors.red),Coordinates(-34.67823093363552, -58.340308498270524),'Julio Humberto Grondona',18500,1957,];
    ...
    mapDetails[_name.centralCordoba] = [ClubColors(Colors.grey,Colors.white),Coordinates(-27.765766, -64.26963233),'Único Madre de Ciudades',30000,1919,];
    ...
    mapDetails[_name.nuevachicago] = [ClubColors(Colors.green,Colors.black),Coordinates(-34.6678528205071, -58.499831612690606),'República de Mataderos',29000,1911,];
    mapDetails[_name.patronato] = [ClubColors(Colors.red,Colors.black),Coordinates(-31.742991743434416, -60.508766064362696),'	Presbítero Bartolomé Grella',22000,1914,];
    ...
    mapDetails[_name.penarol] = [ClubColors(Colors.yellow,Colors.black),Coordinates(-34.7963, -56.06693),'Campeón del Siglo',40000,1891,[_name.nacional]];
    ...
    mapDetails[_name.danubio] = [ClubColors(Colors.white,Colors.black),Coordinates(-34.8387170, -56.13208784133257),'Jardines del Hipódromo',18000,1932,];
    mapDetails[_name.defensor] = [ClubColors(Colors.purple,Colors.white),Coordinates(-34.91616, -56.16653),'Estádio Luis Franzini',16000,1913,];
    ...
    mapDetails[_name.riverURU] = [ClubColors(Colors.red,Colors.white),Coordinates(0,0),'Federico Omar Saroldi',6000,1932,];
    mapDetails[_name.rocha] = [ClubColors(Colors.blue,Colors.white),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.wanderers] = [ClubColors(Colors.white,Colors.black),Coordinates(-34.859011, -56.203837),'Parque Alfredo Víctor Viera',10000,1902,];
    ...
    mapDetails[_name.libertad] = [ClubColors(Colors.black,Colors.white),Coordinates(-25.2768477, -57.61086),'Dr. Nicolás Leoz',10500,1905,];
    mapDetails[_name.guaraniPAR] = [ClubColors(Colors.yellow,Colors.black),Coordinates(-25.30311, -57.61587),'Rogelio Livieres',8000,1903,];
    ...
    mapDetails[_name.cobreloa] = [ClubColors(Colors.orange,Colors.white),Coordinates(-22.46096, -68.9204540),'Municipal de Calama',12000,1977,];
    ...
    mapDetails[_name.unionespanola] = [ClubColors(Colors.red,Colors.yellow),Coordinates(-33.40428485, -70.658703),'Santa Laura',22000,1897,];
    mapDetails[_name.ohiggins] = [ClubColors(Colors.green,Colors.white),Coordinates(-34.1775588, -70.737344506),'El Teniente',14450,1955,];
    ...
    mapDetails[_name.blooming] = [ClubColors(Colors.blue,Colors.black),Coordinates(-17.796, -63.1832),'Tauhichi Aguilera',38000,1946,];
    mapDetails[_name.depmunicipal] = [ClubColors(Colors.red,Colors.white),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.guabira] = [ClubColors(Colors.red,Colors.white),Coordinates(-17.34287, -63.26156460548497),'Gilberto Parada',18000,1962,];
    mapDetails[_name.octubre31] = [ClubColors(Colors.red,Colors.white),Coordinates(0,0),'Estádio',10000,1900,];
    mapDetails[_name.orientePetrolero] = [ClubColors(Colors.white,Colors.green),Coordinates(-17.795982, -63.183182),'Estádio Ramón Tahuichi Aguilera',38500,1955,];
    mapDetails[_name.sanJoseBOL] = [ClubColors(Colors.blue,Colors.white),Coordinates(-17.94613, -67.1108436),'Estádio Jesús Bermúdez',39000,1942,];
    ...
    mapDetails[_name.elnacional] = [ClubColors(Colors.red,Colors.yellow),Coordinates(-0.177371, -78.47598005198135),'Olímpico Atahualpa',45000,1964,];
    ...
    mapDetails[_name.deportivoTachira] = [ClubColors(Colors.white,Colors.black),Coordinates(7.787385, -72.1980212),'Pueblo Nuevo de San Cristóbal',42000,1974,];
    mapDetails[_name.estudiantesmerida] = [ClubColors(Colors.white,Colors.red),Coordinates(8.5769590, -71.16485),'Guillermo Soto Rosa',16500,1971,];
    ...
    mapDetails[_name.zamora] = [ClubColors(Colors.white,Colors.black),Coordinates(8.625075690003603, -70.20694),'Estadio Agustín Tovar',28000,1977,];
    mapDetails[_name.zulia] = [ClubColors(Colors.blue,Colors.black),Coordinates(10.67437234865016, -71.644651),'Estádio José Encarnación Romero',45000,2005,];
    ...
    mapDetails[_name.imedellin] = [ClubColors(Colors.red,Colors.blue),Coordinates(6.256939271878662, -75.58987728982818),'Atanasio Girardot',45953,1913,];
    ...
    mapDetails[_name.bucaramanga] = [ClubColors(Colors.white,Colors.white),Coordinates(7.136745, -73.11619200407239),'Alfonso López',10000,1900,];
    ...
    mapDetails[_name.laequidad] = [ClubColors(Colors.white,Colors.green),Coordinates(4.62375432, -74.13547816181497),'Metropolitano de Techo',15000,1982,];

    //////////////////////////////////////////////////////////////////////////////////
    //MÉXICO
    mapDetails[_name.atlas] = [ClubColors(Colors.red,Colors.black),Coordinates(20.70519168740948, -103.32774841954532),'Jalisco',63163,1916,];
    ...
    mapDetails[_name.chivasguadalajara] = [ClubColors(Colors.red,Colors.white),Coordinates(20.6827395, -103.46255961),'Estadio Akron',49850,1906,];
    ...
    mapDetails[_name.jaguares] = [ClubColors(Colors.black,Colors.white),Coordinates(16.7630, -93.0960),'Estádio Víctor Manuel Reyna',28000,2002,];
    mapDetails[_name.juarez] = [ClubColors(Colors.green,Colors.black),Coordinates(31.75317, -106.467471),'Estadio Olímpico Benito Juárez',19703,2015,];
    ...
    mapDetails[_name.leonesNegros] = [ClubColors(Colors.red,Colors.yellow),Coordinates(20.7052, -103.3277),'Jalisco',63163,1970,];
    ...
    mapDetails[_name.morelia] = [ClubColors(Colors.yellow,Colors.red),Coordinates(19.7189655, -101.233201),'Estadio Morelos',41038,1950,];
    ...
    mapDetails[_name.sanluis] = [ClubColors(Colors.red,Colors.white),Coordinates(22.1389898, -100.95071374670914),'Estadio Alfonso Lastras Ramírez',25709,2013,];
    ...
    mapDetails[_name.fcTokyo] = [ClubColors(Colors.blue,Colors.red),Coordinates(35.66416255606509, 139.5273887800898),'Ajinomoto Stadium',50100,1999,];
    mapDetails[_name.cerezoOsaka] = [ClubColors(Colors.pink,Colors.black),Coordinates(34.61412159266685, 135.51855469354584),'Estádio Nagai',47000,1957,];
    mapDetails[_name.gambaOsaka] = [ClubColors(Colors.red,Colors.black),Coordinates(34.802526,135.538278),'Suita Stadium',39694,1980,];
    mapDetails[_name.kashiwaReysol] = [ClubColors(Colors.yellow,Colors.black),Coordinates(35.8485972, 139.97510173297843),'Hitachi Kashiwa Soccer Stadium',15900,1940,];
    mapDetails[_name.yokohamaMarinos] = [ClubColors(Colors.red,Colors.blue),Coordinates(35.51021666804383, 139.6064795458908),'Estádio Internacional de Yokohama',72327,1972,];
    ...
    mapDetails[_name.alShabab] = [ClubColors(Colors.white,Colors.orange),Coordinates(24.788291361712282, 46.83911094115153),'Estádio Internacional Rei Fahd',75000,1947,];
    ...
    mapDetails[_name.agosto] = [ClubColors(Colors.red,Colors.black),Coordinates(-8.969859115291527, 13.283700367268288),'Estádio Nacional 11 de Novembro',50000,1977,];
    mapDetails[_name.usmAlger] = [ClubColors(Colors.red,Colors.black),Coordinates(36.80114535197307, 3.04854982644877),'Omar Hamadi Stadium',15000,1937,];
    mapDetails[_name.etoileSahel] = [ClubColors(Colors.red,Colors.white),Coordinates(35.823554646619634, 10.613452100113372),'Estádio Olímpico de Sousse',28000,1925,];
    mapDetails[_name.esSetif] = [ClubColors(Colors.black,Colors.white),Coordinates(36.187077735156045, 5.393732917880993),'Estádio 8 de Maio',25000,1958,];
    mapDetails[_name.cotonsport] = [ClubColors(Colors.green,Colors.white),Coordinates(9.326408614446152, 13.399872815711385),'Roumdé Adjia Stadium',35000,1986,];
    mapDetails[_name.enyimba] = [ClubColors(Colors.blue,Colors.white),Coordinates(5.125570, 7.379054),'Enyimba International Stadium',25000,1976,];
    mapDetails[_name.asecMimosas] = [ClubColors(Colors.yellow,Colors.black),Coordinates(5.32845434, -4.0184311),'Stade Robert Champroux',15000,1948,];
  }
