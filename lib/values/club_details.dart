...
class ClubColors{
  ...
  Color thirdColors = Colors.transparent;
  ClubColors(this.primaryColor,this.secondColor,[thirdColor = Colors.transparent]);
}
class Coordinates{
...
class ClubDetails{
  ...
  ClubDetails(){
    //map['generico'] = [ClubColors(Colors.white,Colors.white),Coordinates(0,0),'Estádio',3123,1900,_country.england];
    ...
    map[_name.accrington] = [ClubColors(Colors.red,Colors.white),Coordinates(53.7654, -2.371048),
    ...
    map[_name.burton] = [ClubColors(Colors.yellow,Colors.black),Coordinates(52.821944, -1.626888),
      'Pirelli Stadium',6912,1950,_country.england,];
    map[_name.bradford] = [ClubColors(Colors.orangeAccent,Colors.red),Coordinates(53.804222222,-1.7590222),
    ...
    map[_name.bristolrovers] = [ClubColors(Colors.blue,Colors.white),Coordinates(51.4862678, -2.583142),
    ...
    map[_name.doncaster] = [ClubColors(Colors.red,Colors.white),Coordinates(53.5098730, -1.11355670),
    ...
    map[_name.fleetwood] = [ClubColors(Colors.red,Colors.white),Coordinates(53.91654334, -3.024740453),
      'Highbury Stadium',5327,1908,_country.england,];
    map[_name.gillingham] = [ClubColors(Colors.blue,Colors.black),Coordinates(51.3843096, 0.5607898),
      'KRBS Priestfield Stadium',11582,1893,_country.england,];
    map[_name.huddersfield] = [ClubColors(Colors.blue,Colors.white),Coordinates(53.65416666,-1.76833333),
    ...
    map[_name.ipswichTown] = [ClubColors(Colors.blue,Colors.white),Coordinates(52.05506755, 1.1451992),
			'Portman Road',30311,1878,_country.england,];
    map[_name.lincoln] = [ClubColors(Colors.red,Colors.white),Coordinates(53.218429, -0.54082758),
      'Sincil Bank',10127,1884,_country.england,];
    map[_name.luton] = [ClubColors(Colors.red,Colors.blue),Coordinates(51.883688, -0.4305913),
    ...
    map[_name.mkdons] = [ClubColors(Colors.white,Colors.white),Coordinates(52.0096280, -0.7335208),
    ...
    map[_name.wycombe] = [ClubColors(Colors.lightBlueAccent,darkblue),Coordinates(51.6305577, -0.8001325),
    ...
    map[_name.cittadella] = [ClubColors(grena,Colors.blue),Coordinates(45.642930, 11.7809924),
    ...
    map[_name.como] = [ClubColors(Colors.blue,Colors.white),Coordinates(45.8142475, 9.07235),
			'Giuseppe Sinigaglia',13602,1907,_country.italy,];
    map[_name.cosenza] = [ClubColors(Colors.blue,Colors.red),Coordinates(39.31004544, 16.23091),
    ...
    map[_name.foggia] = [ClubColors(Colors.red,Colors.black),Coordinates(41.45503127, 15.542573),
			'Pino Zaccheria',25085,1920,_country.italy,];
    map[_name.frosinone] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(41.6349811, 13.321672921),
    ...
    map[_name.ternana] = [ClubColors(Colors.green,Colors.red),Coordinates(42.5621775, 12.635254),
    ...
    map[_name.leganes] = [ClubColors(Colors.white,Colors.blue),Coordinates(40.3406935, -3.7602580),
			'Municipal de Butarque',10958,1928,_country.spain,];
    map[_name.lugo] = [ClubColors(Colors.red,Colors.blue),Coordinates(43.003350, -7.57097154),
    ...
    map[_name.merida] = [ClubColors(Colors.white,Colors.black),Coordinates(38.9144846, -6.33649039),
			'Estadio Romano',14600,1912,_country.spain,];
    map[_name.mirandes] = [ClubColors(Colors.white,Colors.black),Coordinates(42.6809190, -2.93530024),
      'Municipal de Anduva',6000,1927,_country.spain,];
    map[_name.murcia] = [ClubColors(Colors.red,Colors.white),Coordinates(38.0424994, -1.14406194),
    ...
    map[_name.ponferradina] = [ClubColors(Colors.blue,Colors.white),Coordinates(42.5574263, -6.599923),
      'El Toralín',8200,1922,_country.spain,];
    map[_name.realmadridB] = [ClubColors(Colors.white,Colors.white),Coordinates(40.477060, -3.61423761),
			'Estádio Alfredo Di Stéfano',12000,1930,_country.spain,];
    map[_name.salamanca] = [ClubColors(Colors.white,Colors.red),Coordinates(40.995500, -5.664743645),
    ...
    map[_name.tenerife] = [ClubColors(Colors.blue,Colors.white),Coordinates(28.463192602, -16.2608979),
			'Heliodoro López',24000,1912,_country.spain,];
    map[_name.toledo] = [ClubColors(Colors.green,Colors.white),Coordinates(39.86914546, -4.0182605),
			'Salto del Caballo',5500,1928,_country.spain,];
    map[_name.racingSantander] = [ClubColors(Colors.green,Colors.black),Coordinates(43.476370, -3.79331518),
      'Estádio El Sardinero',22400,1913,_country.spain,];
    map[_name.realOviedo] = [ClubColors(Colors.blue,Colors.white),Coordinates(43.3608751, -5.86979084),
			'Novo Estádio Carlos Tartiere',30500,1926,_country.spain,];
    map[_name.xerez] = [ClubColors(Colors.blue,Colors.white),Coordinates(36.6896000, -6.1198111),
    ...
    map[_name.aachen] = [ClubColors(Colors.yellow,Colors.black),Coordinates(50.7933333,6.097222222),
    ...
    map[_name.berliner] = [ClubColors(Colors.red,Colors.black),Coordinates(52.54062157, 13.4768246),
    ...
    map[_name.hamburgo] = [ClubColors(Colors.blue,Colors.red),Coordinates(53.5872273, 9.89854),
    ...
    map[_name.heidenheim] = [ClubColors(Colors.red,Colors.blue),Coordinates(48.66851956, 10.13918217),
      'Voith-Arena',15000,1911,_country.germany,];
    map[_name.holsteinkiel] = [ClubColors(Colors.blue,Colors.white),Coordinates(54.349072, 10.12361715),
      'Holstein-Stadion',15034,1900,_country.germany,];
    map[_name.ingolstadt] = [ClubColors(Colors.red,Colors.black),Coordinates(48.745434, 11.485777),
      'Audi-Sportpark',15445,2004,_country.germany,];
    map[_name.jahnregensburg] = [ClubColors(Colors.red,Colors.white),Coordinates(48.99090071, 12.1074654),
      'Jahnstadion Regensburg',15210,1907,_country.germany,];
    map[_name.kaiserslautern] = [ClubColors(Colors.red,Colors.white),Coordinates(49.43448525, 7.77761161),
      'Fritz Walter',49850,1900,_country.germany,];
    map[_name.karlsruher] = [ClubColors(Colors.blue,Colors.white),Coordinates(49.02,8.41305555),
			'Wildparkstadion',32306,1894,_country.germany,];
    map[_name.magdeburg] = [ClubColors(Colors.blue,Colors.white),Coordinates(52.1254076, 11.6705710),
    ...
    map[_name.nurnberg] = [ClubColors(Colors.red,Colors.white),Coordinates(49.42632233, 11.126222),
    ...
    map[_name.sandhausen] = [ClubColors(Colors.white,Colors.black),Coordinates(49.3322165, 8.647684677),
    ...
    map[_name.carlzeissjena] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.germany,];
    map[_name.vorwarts] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.germany,];
    ...
    map[_name.lens] = [ClubColors(Colors.yellow,Colors.red),Coordinates(50.43300186, 2.8153625563302236),
    ...
    map[_name.lorient] = [ClubColors(Colors.orange,Colors.black),Coordinates(47.74833585, -3.36818605),
    ...
    map[_name.troyes] = [ClubColors(Colors.red,Colors.black),Coordinates(48.30766856, 4.0987888),
      'Stade de l\'Aube',20400,1900,_country.france,];

    map[_name.amiens] = [ClubColors(Colors.white,Colors.black),Coordinates(49.89432771, 2.26331715),
			'Stade de la Licorne',12097,1901,_country.france,];
    map[_name.annecy] = [ClubColors(Colors.red,Colors.red),Coordinates(45.9165575, 6.1180684),
    ...
    map[_name.caen] = [ClubColors(Colors.red,Colors.blue),Coordinates(49.17955728, -0.3960764),
			'Michel d\'Ornano',21500,1913,_country.france,];
    map[_name.chamois] = [ClubColors(Colors.blue,Colors.blue),Coordinates(46.3170594, -0.48961761),
      'Stade René-Gaillard',10898,1919,_country.france,];
    map[_name.dijon] = [ClubColors(Colors.red,Colors.white),Coordinates(47.3249340, 5.06840377),
    ...
    map[_name.guingamp] = [ClubColors(Colors.red,Colors.black),Coordinates(48.56549284, -3.1643878),
			'Stade du Roudourou',18256,1912,_country.france,];
    map[_name.lavallois] = [ClubColors(Colors.orange,Colors.orange),Coordinates(48.082332, -0.754686),
      'Stade Francis-Le-Basser',18739,1902,_country.france,];
    map[_name.lehavre] = [ClubColors(Colors.blue,Colors.lightBlueAccent),Coordinates(49.4988613, 0.1698838),
			'Stade Océane',25178,1872,_country.france,];
    map[_name.lemans] = [ClubColors(Colors.red,Colors.yellow),Coordinates(47.95919009, 0.223153075),
    ...
    map[_name.nimes] = [ClubColors(Colors.red,Colors.white),Coordinates(43.8161358, 4.359880),
			'Stade des Costières',18482,1937,_country.france,[_name.montpellier]];
    map[_name.orleans] = [ClubColors(Colors.yellow,Colors.red),Coordinates(47.8406476, 1.9414294),
    ...
    map[_name.pau] = [ClubColors(Colors.yellow,darkblue),Coordinates(43.309443, -0.3169603),
      'Stade du Hameau',13966,1920,_country.france,];
    map[_name.quevilly] = [ClubColors(Colors.red,Colors.yellow),Coordinates(49.427630, 1.0512107),
      'Amable Lozai',2500,1902,_country.france,];
    map[_name.redstar] = [ClubColors(Colors.green,Colors.red),Coordinates(48.90659978, 2.34197952),
			'Stade Bauer',10000,1897,_country.france,];
    map[_name.rodez] = [ClubColors(Colors.red,Colors.yellow),Coordinates(44.351570, 2.5637119),
      'Stade Paul-Lignon',5955,1929,_country.france,];
    map[_name.rouen] = [ClubColors(Colors.red,Colors.black),Coordinates(49.41143361, 1.07069394),
    ...
    map[_name.sedan] = [ClubColors(Colors.green,Colors.red),Coordinates(49.69404732, 4.93880095),
    ...
    map[_name.valenciennes] = [ClubColors(Colors.red,Colors.black),Coordinates(50.3490100, 3.5325451),
			'Stade du Hainaut',25172,1913,_country.france,];
    map[_name.villefranche] = [ClubColors(Colors.blue,Colors.blue),Coordinates(46.00, 4.7073536),
      'Stade Armand Chouffet',5000,1927,_country.france,];

    //PORTUGAL
    map[_name.benfica] = [ClubColors(Colors.red,Colors.white),Coordinates(38.75301495, -9.1844710),
    ...
    map[_name.estrelaamadora] = [ClubColors(Colors.red,Colors.green),Coordinates(38.75216476, -9.22726611),
			'Estádio José Gomes',9288,1932,_country.portugal,];
    map[_name.famalicao] = [ClubColors(Colors.blue,Colors.blue),Coordinates(41.4016829, -8.52243319),
			'Estádio Municipal de Famalicão',5307,1931,_country.portugal,];
    map[_name.farense] = [ClubColors(Colors.white,Colors.black),Coordinates(37.02232811, -7.928202),
			'Estádio de São Luís',7000,1910,_country.portugal,];
    map[_name.feirense] = [ClubColors(Colors.blue,Colors.white),Coordinates(40.926660, -8.545820),
    ...
    map[_name.leixoes] = [ClubColors(Colors.white,Colors.red),Coordinates(41.1842451364265, -8.666396418),
			'Estádio do Mar',9821,1907,_country.portugal,];
    map[_name.mafra] = [ClubColors(Colors.yellow,Colors.green),Coordinates(-26.1286357, -49.80125986),
    ...
    map[_name.moreirense] = [ClubColors(Colors.green,Colors.white),Coordinates(41.3782047, -8.3542469),
    ...
    map[_name.pacosDeFerreira] = [ClubColors(Colors.yellow,Colors.green),Coordinates(41.27144668, -8.38488781),
			'Capital do Móvel',9077,1950,_country.portugal,];
    map[_name.penafiel] = [ClubColors(Colors.red,Colors.black),Coordinates(41.211768, -8.27777600),
			'Estádio Municipal 25 de Abril',5300,1951,_country.portugal,];
    map[_name.portimonense] = [ClubColors(Colors.black,Colors.white),Coordinates(37.13588, -8.540001),
			'Estádio Municipal de Portimão',6000,1914,_country.portugal,];
    map[_name.olhanense] = [ClubColors(Colors.red,Colors.black),Coordinates(37.029370, -7.84837313),
			'Estádio José Arcanjo',10080,1912,_country.portugal,];
    map[_name.rioAve] = [ClubColors(Colors.green,Colors.white),Coordinates(41.3628257, -8.73965321),
			'Estádio dos Arcos',5000,1939,_country.portugal,];
    map[_name.salgueiros] = [ClubColors(Colors.red,Colors.white),Coordinates(41.15904746, -8.572435608280456),
    ...
    map[_name.vilafranquense] = [ClubColors(Colors.white,Colors.red),Coordinates(38.94535, -8.99430208),
    ...
    //HOLANDA
    map[_name.ajax] = [ClubColors(Colors.red,Colors.white),Coordinates(52.3141666,4.9419444),
			'Johan Cruijff Arena',54990,1900,_country.netherlands,[_name.psv,_name.feyenoord]];
    map[_name.feyenoord] = [ClubColors(Colors.red,Colors.black),Coordinates(51.89389444,4.52325277),
			'De Kuip',51577,1908,_country.netherlands,[_name.psv,_name.ajax]];
    map[_name.psv] = [ClubColors(Colors.red,Colors.white),Coordinates(51.4418878, 5.46784477),
			'Philips Stadion',35000,1912,_country.netherlands,[_name.ajax,_name.feyenoord]];
    map[_name.azAlkmaar] = [ClubColors(Colors.red,Colors.white),Coordinates(52.6130966, 4.742401887),
			'AFAS Stadium',17023,1967,_country.netherlands,];
    map[_name.cambuur] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(53.2055474, 5.8145969),
      'Cambuur Stadion',10000,1964,_country.netherlands,];
    map[_name.denhaag] = [ClubColors(Colors.yellow,Colors.green),Coordinates(52.0628811, 4.383067425),
			'Estádio Cars Jeans',15000,1905,_country.netherlands,];
    map[_name.emmen] = [ClubColors(Colors.white,Colors.red),Coordinates(52.77479885, 6.9456866),
      'Univé Stadion',8700,1925,_country.netherlands,];
    map[_name.excelsior] = [ClubColors(Colors.black,Colors.red),Coordinates(51.9170728, 4.520500),
      'Stadion Woudestein',3531,1902,_country.netherlands,];
    map[_name.fortunasittard] = [ClubColors(Colors.yellow,Colors.green),Coordinates(50.9919321, 5.8437577),
      'Wagner & Partners Stadion',12500,1968,_country.netherlands,];
    map[_name.goaheadeagles] = [ClubColors(Colors.red,Colors.yellow),Coordinates(52.2604448, 6.1726971),
      'De Adelaarshorst',10500,1902,_country.netherlands,];
    map[_name.groningen] = [ClubColors(Colors.white,Colors.green),Coordinates(53.2062203, 6.59170906),
			'Euroborg',22329,1915,_country.netherlands,];
    map[_name.heerenveen] = [ClubColors(Colors.black,Colors.white),Coordinates(52.9588595, 5.93625977),
			'Abe Lenstra',12080,1920,_country.netherlands,];
    map[_name.heracles] = [ClubColors(Colors.blue,Colors.white),Coordinates(52.3389281, 6.650802339),
      'Polman Stadion',26100,1903,_country.netherlands,];
    map[_name.necnijmegen] = [ClubColors(Colors.red,Colors.green),Coordinates(51.822486, 5.837214),
      'Stadion de Goffert',12500,1900,_country.netherlands,];
    map[_name.rodajc] = [ClubColors(Colors.yellow,Colors.black),Coordinates(50.8572678, 6.0058343),
    ...
    map[_name.spartarotterdam] = [ClubColors(Colors.red,Colors.white),Coordinates(51.9200241, 4.4337761),
    ...
    map[_name.utrecht] = [ClubColors(Colors.red,Colors.black),Coordinates(52.0785286, 5.14622137),
			'Galgenwaard',24426,1970,_country.netherlands,];
    map[_name.vitesse] = [ClubColors(Colors.yellow,Colors.white),Coordinates(51.96292454, 5.8930736),
			'GelreDome',21248,1892,_country.netherlands,];
    map[_name.volendam] = [ClubColors(Colors.orange,Colors.black),Coordinates(52.4945818, 5.06643744),
      'Kras Stadion',6260,1920,_country.netherlands,];
    map[_name.waalwijk] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(51.686679, 5.089090),
      'Mandemakers Stadion',7500,1940,_country.netherlands,];
    map[_name.willem] = [ClubColors(Colors.blue,Colors.red),Coordinates(51.5430195, 5.067781659),
			'Willen II Stadion',45500,1896,_country.netherlands,];
    map[_name.zwolle] = [ClubColors(Colors.blue,Colors.white),Coordinates(52.5171852, 6.120810235),
      'IJsseldeltastadion',12500,1910,_country.netherlands,];
    map[_name.dws] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.netherlands,];

    //BELGICA
    map[_name.anderlecht] = [ClubColors(Colors.purple,Colors.white),Coordinates(50.8344335, 4.2979681),
			'Constant Vanden Stock',28063,1908,_country.belgium,];
    map[_name.beveren] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(51.2143650, 4.2442212),
      'Freethiel Stadion',13290,1936,_country.belgium,];
    map[_name.brugge] = [ClubColors(Colors.blue,Colors.black),Coordinates(51.1933339, 3.180370),
			'Jan Breydel',30000,1891,_country.belgium,];
    map[_name.cerclebrugge] = [ClubColors(Colors.green,Colors.black),Coordinates(51.1934139, 3.1807351),
      'Jan Breydel',29062,1899,_country.belgium,];
    map[_name.charleroi] = [ClubColors(Colors.white,Colors.black),Coordinates(50.4148749, 4.45318367),
      'Stade du Pays de Charleroi',25000,1904,_country.belgium,];
    map[_name.genk] = [ClubColors(Colors.blue,Colors.white),Coordinates(51.0050548, 5.5335494),
			'Cristal Arena',24604,1988,_country.belgium,];
    map[_name.gent] = [ClubColors(Colors.blue,Colors.white),Coordinates(51.01671567, 3.73471876),
			'Ghelamco Arena',20000,1900,_country.belgium,];
    map[_name.kaseupen] = [ClubColors(Colors.white,Colors.black),Coordinates(50.6263931, 6.04539),
      'Kehrwegstadion',8366,1945,_country.belgium,];
    map[_name.kortrijk] = [ClubColors(Colors.white,Colors.black),Coordinates(50.83036, 3.2491287),
      'Guldensporenstadion',9500,1901,_country.belgium,];
    map[_name.lierse] = [ClubColors(Colors.yellow,Colors.black),Coordinates(51.1443335, 4.57393474),
			'Herman Vanderpoorten Stadion',15500,1906,_country.belgium,];
    map[_name.mechelen] = [ClubColors(Colors.red,Colors.yellow),Coordinates(51.036870, 4.487291538),
      'AFAS Stadion',10000,1904,_country.belgium,];
    map[_name.oostende] = [ClubColors(Colors.red,Colors.green),Coordinates(51.2169176, 2.886586),
      'Albertparkstadion',10000,1904,_country.belgium,];
    map[_name.royalAntwerp] = [ClubColors(Colors.red,Colors.white),Coordinates(51.23260, 4.47252263),
			'Stadium “BOSUIL“',10000,1880,_country.belgium,];
    map[_name.standardliege] = [ClubColors(Colors.red,Colors.white),Coordinates(50.609929, 5.544381876),
      'Maurice Dufrasne',30030,1898,_country.belgium,];
    map[_name.sttruidense] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(50.8134616, 5.166361),
      'Estádio Stayen',11250,1933,_country.belgium,];
    map[_name.saintgilloise] = [ClubColors(Colors.yellow,darkblue),Coordinates(50.8178096, 4.329303),
      'Stade Joseph Marien',6000,1897,_country.belgium,];
    map[_name.westerlo] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(51.0947729, 4.928768),
      'Het Kuipje',7982,1933,_country.belgium,];
    map[_name.zulteWaregem] = [ClubColors(Colors.white,Colors.red),Coordinates(50.88311, 3.42904),
    ...
    //ESCOCIA
    map[_name.aberdeen] = [ClubColors(Colors.red,Colors.white),Coordinates(57.15986178, -2.0880853),
    ...
    map[_name.dundee] = [ClubColors(Colors.orange,Colors.black),Coordinates(56.4748207, -2.9686031),
			'Tannadice Park',14209,1909,_country.scotland,];
    map[_name.hibernian] = [ClubColors(Colors.green,Colors.white),Coordinates(55.96189876, -3.1650656),
    ...
    map[_name.livingstone] = [ClubColors(Colors.black,Colors.yellow),Coordinates(55.88594835, -3.522035),
      'Almondvale Stadium',9521,1943,_country.scotland,];
    map[_name.motherwell] = [ClubColors(Colors.yellow,Colors.redAccent),Coordinates(55.7804536, -3.9800776),
      'Fir Park',13742,1886,_country.scotland,];
    map[_name.rangers] = [ClubColors(Colors.blue,Colors.white),Coordinates(55.8530555,-4.309166666),
      'Ibrox Stadium',50817,1872,_country.scotland,[_name.celtic]];
    map[_name.rossCounty] = [ClubColors(darkblue,Colors.red),Coordinates(57.59589451, -4.4187127),
      'Victoria Park',6310,1929,_country.scotland,];
    map[_name.stmirren] = [ClubColors(Colors.black,Colors.white),Coordinates(55.8506123, -4.4442139),
      'St Mirren Park',7937,1877,_country.scotland,];
    map[_name.stjohnstone] = [ClubColors(Colors.blue,Colors.white),Coordinates(56.409916, -3.4767773),
      'McDiarmid Park',10696,1884,_country.scotland,];
    //IRLANDA DO NORTE
    map[_name.crusaders] = [ClubColors(Colors.red,Colors.black),Coordinates(54.624341808, -5.92197737),
      'Seaview',3054,1898,_country.northernIreland,];
    map[_name.glentoran] = [ClubColors(Colors.green,Colors.red),Coordinates(51.4838900, -0.1146840),
      'The Oval',26556,1882,_country.northernIreland,];
    map[_name.linfield] = [ClubColors(Colors.blue,Colors.white),Coordinates(54.582700, -5.95480680),
    ...
    map[_name.cork] = [ClubColors(Colors.green,Colors.white),Coordinates(51.885517701229794, -8.468353748),
			'Turner Cross',7000,1984,_country.ireland,];
    map[_name.derry] = [ClubColors(Colors.red,Colors.white),Coordinates(54.990852621806944, -7.336110758),
			'Brandywell',7700,1928,_country.ireland,];
    map[_name.dundalk] = [ClubColors(Colors.white,Colors.black),Coordinates(53.99921346123983, -6.41599349),
			'Oriel Park',13600,1919,_country.ireland,];
    map[_name.shamrock] = [ClubColors(Colors.green,Colors.white),Coordinates(53.28363777, -6.373458012),
			'Estádio de Tallaght',6000,1899,_country.ireland,];
    map[_name.waterford] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.ireland,];

    //NORDICOS
    //NORUEGA
    map[_name.aalesund] = [ClubColors(Colors.orange,Colors.blue),Coordinates(62.46965856, 6.1872397),
      'Color Line Stadion',10778,1914,_country.norway,];
    map[_name.fredrikstad] = [ClubColors(Colors.red,Colors.white),Coordinates(59.2116267, 10.9374700),
			'Nye Fredrikstad Stadion',13300,1903,_country.norway,];
    map[_name.glimt] = [ClubColors(Colors.yellow,Colors.black),Coordinates(67.27666691, 14.38474245),
    ...
    map[_name.lyn] = [ClubColors(Colors.red,Colors.blue),Coordinates(59.9491344, 10.734334),
			'Ullevaal Stadion',25572,1896,_country.norway,];
    map[_name.molde] = [ClubColors(Colors.blue,Colors.white),Coordinates(62.73348179, 7.1483130),
			'Aker Stadion',11167,1911,_country.norway,[_name.rosenborg]];
    map[_name.odd] = [ClubColors(Colors.black,Colors.white),Coordinates(59.2114814, 9.5900116),
      'Skagerak Arena',13500,1894,_country.norway,];
    map[_name.rosenborg] = [ClubColors(Colors.black,Colors.white),Coordinates(63.41251977, 10.405168),
      'Lerkendal Stadion',21405,1917,_country.norway,[_name.molde]];
    map[_name.valerenga] = [ClubColors(Colors.blue,Colors.white),Coordinates(59.9492525, 10.7344950),
    ...
    map[_name.djurgarden] = [ClubColors(Colors.lightBlueAccent,darkblue),Coordinates(59.291191, 18.084667),
			'Stockholmsarenan',33000,1899,_country.sweden,];
    map[_name.elfsborg] = [ClubColors(Colors.yellow,Colors.black),Coordinates(57.734357, 12.9347772),
			'Arena de Borås',17000,1904,_country.sweden,];
    map[_name.hacken] = [ClubColors(Colors.yellow,Colors.black),Coordinates(57.71921, 11.93074),
      'Bravida Arena',8480,1940,_country.sweden,];
    map[_name.hammarby] = [ClubColors(Colors.green,Colors.white),Coordinates(59.290854, 18.085401),
			'Tele2 Arena',33000,1915,_country.sweden,];
    map[_name.helsingborg] = [ClubColors(Colors.red,Colors.blue),Coordinates(59.345391, 18.0790722),
			'Stockholm Olympic Stadium',17100,1907,_country.sweden,];
    map[_name.kalmar] = [ClubColors(Colors.red,Colors.white),Coordinates(56.6693123, 16.3598183),
    ...
    map[_name.malmo] = [ClubColors(Colors.blue,Colors.white),Coordinates(55.583611,12.987777),
			'Eleda Stadion',24000,1910,_country.sweden,];
    map[_name.mjallby] = [ClubColors(Colors.yellow,Colors.black),Coordinates(56.0120291, 14.71628237),
    ...
    map[_name.sirius] = [ClubColors(Colors.blue,Colors.black),Coordinates(59.849614, 17.6454),
    ...
    map[_name.silkeborg] = [ClubColors(Colors.red,Colors.white),Coordinates(56.157916, 9.5540119),
    ...
    map[_name.viborg] = [ClubColors(Colors.green,Colors.white),Coordinates(56.455972956, 9.4020026),
      'Viborg Stadium',9566,1896,_country.denmark,];
    map[_name.b1903] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.denmark,];
    map[_name.b1909] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.denmark,];
    map[_name.ab] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.denmark,];
    map[_name.hvidovre] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.denmark,];
    //FINLANDIA
    ...
    map[_name.lahti] = [ClubColors(Colors.black,Colors.red),Coordinates(60.98651281, 25.65060111641216),
			'Lahden Stadion',14465,1996,_country.finland,];
    map[_name.kuusysi] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.finland,];
    map[_name.turku] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.finland,];
    //ISLANDIA
    map[_name.akraness] = [ClubColors(Colors.yellow,Colors.black),Coordinates(64.3181903, -22.05713664),
			'Akranesvöllur',6000,1946,_country.iceland,];
    map[_name.breidablik] = [ClubColors(Colors.green,Colors.white),Coordinates(64.10421594, -21.8969209),
      'Kópavogsvöllur',5501,1950,_country.iceland,];
    map[_name.hafnarfjardar] = [ClubColors(Colors.white,Colors.black),Coordinates(64.07608583, -21.935295742),
			'Kaplakriki',6450,1928,_country.iceland,];
    map[_name.reykjavik] = [ClubColors(Colors.black,Colors.white),Coordinates(64.14640062, -21.96675625),
      'KR-völlur',6000,1899,_country.iceland,];
    map[_name.valur] = [ClubColors(Colors.red,Colors.white),Coordinates(64.13294129158774, -21.9229681),
      'Vodafonevöllurinn',3000,1911,_country.iceland,];
    map[_name.vikingur] = [ClubColors(Colors.red,Colors.black),Coordinates(64.11637343, -21.85500321),
			'Víkingsvöllur',1450,1908,_country.iceland,];
    //ILHAS FAROE
    map[_name.b36] = [ClubColors(Colors.blue,Colors.white),Coordinates(62.019293, -6.7805902),
      'Gundadalur',5000,1936,_country.faroe,];
    map[_name.hb] = [ClubColors(Colors.red,Colors.black),Coordinates(62.0192123, -6.7779013),
      'Gundadalur',5000,1904,_country.faroe,];
    map[_name.klaksvik] = [ClubColors(Colors.blue,Colors.white),Coordinates(62.224696, -6.580514426),
      'Djúpumýra Klaksvík',1500,1904,_country.faroe,];
    map[_name.vikingurFaroe] = [ClubColors(Colors.lightBlueAccent,Colors.black),Coordinates(62.199574, -6.7458078),
      'Serpugerdi Stadium',16000,2008,_country.faroe,];

    //AUSTRIA
    map[_name.admira] = [ClubColors(Colors.black,Colors.red),Coordinates(48.097542, 16.3113277),
      'Bundesstadion Südstadt',10000,1905,_country.austria,];
    map[_name.austria] = [ClubColors(Colors.purple,Colors.white),Coordinates(48.16250323, 16.3876322),
      'Franz Horr',17656,1911,_country.austria,];
    map[_name.hartberg] = [ClubColors(Colors.blue,Colors.blue),Coordinates(47.2811738, 15.9776617),
      'Arena Hartberg',4500,1946,_country.austria,];
    map[_name.laskLinz] = [ClubColors(Colors.red,Colors.black),Coordinates(48.2938258, 14.2766143),
			'Linzer Stadion',30138,1908,_country.austria,];
    map[_name.rapidviena] = [ClubColors(Colors.green,Colors.white),Coordinates(48.19810877, 16.2660961),
      'Allianz Stadion',28000,1899,_country.austria,];
    map[_name.rbsalzburg] = [ClubColors(Colors.white,Colors.red),Coordinates(47.8163615, 12.9986015),
      'Red Bull Arena',31895,2005,_country.austria,];
    map[_name.ried] = [ClubColors(Colors.green,Colors.black),Coordinates(48.207823, 13.478552),
      'Keine Sorgen Arena',7680,1912,_country.austria,];
    map[_name.sturmGraz] = [ClubColors(Colors.black,Colors.white),Coordinates(47.0466456, 15.4552685),
    ...
    map[_name.wolfsberger] = [ClubColors(Colors.white,Colors.black),Coordinates(46.8263069, 14.852003),
      'Lavanttal-Arena',7300,1930,_country.austria,];
    map[_name.innsbruck] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.austria,];
    map[_name.wiener] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.austria,];
    //SUIÇA
    map[_name.basel] = [ClubColors(Colors.red,Colors.blue),Coordinates(47.54169074, 7.62067642),
    ...
    map[_name.lugano] = [ClubColors(Colors.black,Colors.white),Coordinates(46.023828, 8.96135788),
      'Stadio de Cornaredo',10500,1908,_country.switzerland,];
    map[_name.luzern] = [ClubColors(Colors.blue,Colors.white),Coordinates(47.03307, 8.3051154),
      'Swissporarena',13000,1901,_country.switzerland,];
    map[_name.sion] = [ClubColors(Colors.red,Colors.white),Coordinates(46.23353628, 7.37640473),
    ...
    map[_name.stgallen] = [ClubColors(Colors.green,Colors.white),Coordinates(47.408398945, 9.3057807),
      'Kybunpark',19694,1879,_country.switzerland,];
    map[_name.thun] = [ClubColors(Colors.red,Colors.white),Coordinates(46.7439056, 7.60663322),
			'Stockhorn Arena',10300,1898,_country.switzerland,];
    map[_name.youngBoys] = [ClubColors(Colors.yellow,Colors.black),Coordinates(46.9633758, 7.4653358),
      'Estádio da Suíça',32000,1898,_country.switzerland,];
    map[_name.winterthur] = [ClubColors(Colors.green,Colors.white),Coordinates(47.5008475, 8.717600),
    ...
    map[_name.chauxdefonds] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(0, 0),
    ...
    //POLONIA
    map[_name.gornik] = [ClubColors(Colors.white,Colors.black),Coordinates(50.296646268, 18.7696376),
			'Estádio Ernest Pohl',24563,1948,_country.poland,];
    map[_name.gwardia] = [ClubColors(Colors.red,Colors.blue),Coordinates(52.19919178, 20.99196),
			'Stadion WKS Gwardia',9000,1948,_country.poland,];
    map[_name.legiaWarszawa] = [ClubColors(Colors.green,Colors.white),Coordinates(52.220579264, 21.0408855),
			'Pepsi Arena',31000,1916,_country.poland,];
    map[_name.lechiagdansk] = [ClubColors(Colors.white,Colors.green),Coordinates(54.3900689, 18.6404273),
      'PGE Arena Gdańsk',43165,1945,_country.poland,];
    map[_name.lechPoznan] = [ClubColors(Colors.blue,Colors.white),Coordinates(52.39775183, 16.8587159),
			'Estádio Municipal de Poznań',41609,1922,_country.poland,];
    map[_name.piastGliwice] = [ClubColors(Colors.blue,Colors.red),Coordinates(50.3066789, 18.695438),
      'Stadion Miejski im. Piotra Wieczorka',9913,1945,_country.poland,];
    map[_name.pogon] = [ClubColors(grena,Colors.blue),Coordinates(53.43655020, 14.51868017),
      'Estádio Florian Krygier',8990,1948,_country.poland,];
    map[_name.rakow] = [ClubColors(Colors.red,Colors.blue),Coordinates(50.7767924, 19.159192),
      'Miejski Stadion Piłkarski',5500,1921,_country.poland,];
    map[_name.ruchchorzow] = [ClubColors(Colors.blue,Colors.white),Coordinates(50.28228733, 18.94527638),
			'Stadion Ruchu Chorzów',9300,1920,_country.poland,];
    map[_name.slaskwrocklaw] = [ClubColors(Colors.green,Colors.red),Coordinates(51.14125077, 16.94370316),
      'Municipal de Wroclaw',44416,1947,_country.poland,];
    map[_name.wislaPlock] = [ClubColors(Colors.blue,Colors.white),Coordinates(52.5620205, 19.68411),
      'Estádio Kazimierz Górski',12800,1947,_country.poland,];
    map[_name.wislaKrakow] = [ClubColors(Colors.red,Colors.white),Coordinates(50.0638402, 19.91199072),
			'Estádio Henryk Reyman',33326,1906,_country.poland,];
    map[_name.widzew] = [ClubColors(Colors.red,Colors.white),Coordinates(51.764935, 19.51160286),
    ...
    //TURQUIA
    map[_name.adanaspor] = [ClubColors(Colors.orange,Colors.black),Coordinates(37.06372554, 35.37545482),
			'Novo Estádio de Adana',33543,1954,_country.turkey,];
    map[_name.alanyaspor] = [ClubColors(Colors.orange,Colors.green),Coordinates(36.5626171, 32.0791125),
      'Estádio do Colégio Bahçeşehir',10842,1948,_country.turkey,];
    map[_name.antalyaspor] = [ClubColors(Colors.red,Colors.white),Coordinates(36.8884456, 30.66902964),
			'Estádio de Antália',32539,1966,_country.turkey,];
    map[_name.besiktas] = [ClubColors(Colors.black,Colors.white),Coordinates(41.0394909, 28.99474848),
      'Vodafone Park',41903,1903,_country.turkey,[_name.fenerbahce,_name.galatasaray]];
    map[_name.bursaspor] = [ClubColors(Colors.green,Colors.red),Coordinates(40.210638, 29.009436),
			'Municipal Metropolitano de Bursa',42331,1963,_country.turkey,];
    map[_name.denizlispor] = [ClubColors(Colors.green,Colors.black),Coordinates(37.76621147, 29.08265607),
			'Denizli Atatürk Stadyumu',18745,1966,_country.turkey,];
    map[_name.fenerbahce] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(40.9877951, 29.036899),
    ...
    map[_name.karagumruk] = [ClubColors(Colors.red,Colors.black),Coordinates(41.07463764, 28.765735),
      'Estádio Olímpico Atatürk',75145,1926,_country.turkey,];
    map[_name.kasimpasa] = [ClubColors(Colors.white,darkblue),Coordinates(41.0327862, 28.9723363),
      'Estádio Recep Tayyip Erdoğan',14234,1921,_country.turkey,];
    map[_name.goztepe] = [ClubColors(Colors.red,Colors.yellow),Coordinates(38.3955952, 27.0760464),
			'Estádio Gürsel Aksel',20035,1925,_country.turkey,];
    map[_name.hatayspor] = [ClubColors(grena,Colors.white),Coordinates(36.258447, 36.2078878),
      'New Hatay Stadium',26600,1967,_country.turkey,];
    map[_name.instanbul] = [ClubColors(Colors.red,Colors.blue),Coordinates(41.12323595, 28.808461462),
      'Fatih Terim de Başakşehir',17319,1990,_country.turkey,];
    map[_name.konyaspor] = [ClubColors(Colors.white,Colors.green),Coordinates(37.9463311, 32.48842835),
			'Estádio Municipal Metropolitano de Cônia',41981,1922,_country.turkey,];
    map[_name.gaziantepspor] = [ClubColors(Colors.white,Colors.red),Coordinates(37.1230653, 37.3837841),
			'Estádio de Gaziantepe',35574,1988,_country.turkey];
    map[_name.malatyaspor] = [ClubColors(Colors.yellow,Colors.red),Coordinates(38.337827, 38.4464651),
      'Novo Estádio de Malatya',27044,1986,_country.turkey];
    map[_name.rizespor] = [ClubColors(Colors.blue,Colors.green),Coordinates(41.0420904, 40.5733391),
      'Novo Estádio Municipal de Rize',15568,1953,_country.turkey];
    map[_name.sivasspor] = [ClubColors(Colors.red,Colors.white),Coordinates(39.7245242, 36.97510870),
    ...
    map[_name.asteras] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(37.50264465, 22.388388),
      'Asteras Tripolis Stadium',6430,1931,_country.greece,];
    map[_name.pasGiannina] = [ClubColors(Colors.blue,Colors.white),Coordinates(39.6676117, 20.84881764),
      'Zosimades Stadium',7500,1966,_country.greece,];
    map[_name.ionikos] = [ClubColors(Colors.blue,Colors.white),Coordinates(37.9772289, 23.634989),
      'Neapolis Nikaia',5000,1965,_country.greece,];
    map[_name.ofi] = [ClubColors(Colors.white,Colors.black),Coordinates(35.3368787, 25.106282),
    ...
    //CHIPRE
    map[_name.aeklarnaca] = [ClubColors(Colors.yellow,Colors.green),Coordinates(34.9264739, 33.5976785),
      'AEK arena',13032,1994,_country.cyprus,];
    map[_name.apoel] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(35.1145399, 33.3630869672),
    ...
    map[_name.anorthosis] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.cyprus,];
    //ISRAEL
    map[_name.ashdod] = [ClubColors(Colors.red,Colors.red),Coordinates(31.8104802, 34.648333),
      'Estádio HaYud-Alef',8200,1999,_country.israel,];
    map[_name.beitarJerusalem] = [ClubColors(Colors.yellow,Colors.black),Coordinates(31.7513445, 35.190685),
      'Teddy Stadium',34000,1936,_country.israel,];
    map[_name.hapoelBerSheva] = [ClubColors(Colors.red,Colors.white),Coordinates(31.2734850, 34.779789),
    ...
    map[_name.anzhi] = [ClubColors(Colors.yellow,Colors.black),Coordinates(42.9079000, 47.618420),
			'Arena Anji',10000,1991,_country.russia,];
    map[_name.cska] = [ClubColors(Colors.red,Colors.blue),Coordinates(55.7921064, 37.5159460),
      'VEB Arena',30000,1911,_country.russia,];
    map[_name.dinamoMoscou] = [ClubColors(Colors.blue,Colors.white),Coordinates(55.79095156, 37.5610590),
      'Dinamo Lev Yashin Stadium',36000,1923,_country.russia,];
    map[_name.khimki] = [ClubColors(Colors.green,Colors.black),Coordinates(55.8854723, 37.454475),
      'Arena Khimki',18636,1997,_country.russia,];
    map[_name.krasnodar] = [ClubColors(Colors.green,Colors.black),Coordinates(45.0450492, 39.0294265),
    ...
    map[_name.orenburg] = [ClubColors(Colors.blue,Colors.white),Coordinates(51.7851665, 55.2210744),
    ...
    map[_name.torpedo] = [ClubColors(Colors.white,Colors.black),Coordinates(55.7164327, 37.6563151),
			'Eduard Streltsov',13400,1930,_country.russia,];
    map[_name.tula] = [ClubColors(Colors.red,Colors.yellow),Coordinates(54.17481890, 37.6025909),
    ...
    map[_name.lviv] = [ClubColors(Colors.red,Colors.blue),Coordinates(49.7749650, 24.02770639),
      'Arena Lviv',34915,1992,_country.ukraine,];
    map[_name.metalist] = [ClubColors(Colors.yellow,Colors.white),Coordinates(49.9810, 36.2617732),
      'OSC Metalist',40003,1925,_country.ukraine,];
    map[_name.shaktardonetsk] = [ClubColors(Colors.orange,Colors.black),Coordinates(50.433542433, 30.522135),
      'Donbass Arena',52187,1936,_country.ukraine,[_name.dinamokiev]];
    map[_name.zorya] = [ClubColors(Colors.black,Colors.white),Coordinates(47.859599, 35.097371331),
    ...
    //AZERBAIJÃO
    map[_name.qarabag] = [ClubColors(Colors.black,Colors.white),Coordinates(40.3974049, 49.852724642),
			'Estádio Tofig Bahramov',31200,1951,_country.azerbaijan,];
    //CAZAQUISTÃO
    map[_name.aktobe] = [ClubColors(Colors.red,Colors.red),Coordinates(50.29155, 57.15927),
      'Aktobe Central Stadium',13200,1967,_country.kazakhstan,];
    map[_name.astana] = [ClubColors(Colors.white,Colors.blue),Coordinates(51.1083829, 71.4031747),
			'Astana Arena',30000,2009,_country.kazakhstan,];
    //map[_name.irtysh] = [ClubColors(Colors.blue,Colors.white),Coordinates(0,0),
    //  'Central Stadium',20000,1965,_country.kazakhstan,]; //EXTINTO 2020
    map[_name.kairat] = [ClubColors(Colors.yellow,Colors.black),Coordinates(43.238482, 76.924193),
			'Central Stadium',23804,1954,_country.kazakhstan,];
    map[_name.okzhetpes] = [ClubColors(Colors.blue,Colors.white),Coordinates(53.285220, 69.3924265),
      'Okzhetpes Stadium',10000,1957,_country.kazakhstan,];
    map[_name.ordabasy] = [ClubColors(Colors.white,Colors.blue),Coordinates(42.335537, 69.59348),
      'Kazhimukan Munaitpasov Stadium',20000,1958,_country.kazakhstan,];
    map[_name.shakhter] = [ClubColors(Colors.black,Colors.black),Coordinates(49.8186566, 73.0752474),
      'Shakhter Stadium',19000,1958,_country.kazakhstan,];
    map[_name.taraz] = [ClubColors(Colors.blue,Colors.white),Coordinates(42.902019, 71.382288),
    ...
    map[_name.batumi] = [ClubColors(Colors.white,Colors.blue),Coordinates(41.8126276, 41.77440),
      'Chele Arena',6000,1923,_country.georgia,];
    map[_name.dila] = [ClubColors(Colors.red,Colors.blue),Coordinates(41.983075, 44.1038858),
    ...
    map[_name.araratYerevan] = [ClubColors(Colors.red,Colors.white),Coordinates(40.18052, 44.4948721),
			'Hrazdan Stadium',53849,1935,_country.armenia,];
    map[_name.alashkent] = [ClubColors(Colors.yellow,Colors.black),Coordinates(40.15448480, 44.47532),
			'Alashkert Stadium',22570,1921,_country.armenia,];
    map[_name.pyunikyerevan] = [ClubColors(Colors.red,Colors.white),Coordinates(40.17168518, 44.5257160),
    ...
    //LATVIA
    map[_name.rigafc] = [ClubColors(Colors.lightBlueAccent,Colors.white),Coordinates(56.961413, 24.116308),
			'Skonto',9100,2014,_country.latvia,];
    map[_name.rigaRFS] = [ClubColors(Colors.blue,Colors.white),Coordinates(56.90891835, 24.15514115),
      'LNK Sporta Parks',1000,2011,_country.latvia,];
    map[_name.valmiera] = [ClubColors(Colors.black,Colors.white),Coordinates(57.5410309, 25.4417177),
      'Jānis Daliņš',2000,1996,_country.latvia,];
    //LITHUANIA
    map[_name.suduva] = [ClubColors(Colors.red,Colors.black),Coordinates(54.5747184, 23.365261),
      'Marijampolės futbolo arena',6250,1968,_country.lithuania,];
    map[_name.kaunu] = [ClubColors(Colors.green,Colors.white),Coordinates(54.89744355, 23.937322),
    ...
    //SERVIA
    map[_name.estrelavermelha] = [ClubColors(Colors.red,Colors.white),Coordinates(44.783172, 20.465097),
			'Rajko Mitić',55538,1945,_country.serbia,[_name.partizan]];
    map[_name.partizan] = [ClubColors(Colors.black,Colors.white),Coordinates(44.7886175, 20.45902),
			'Stadion Partizana',32710,1945,_country.serbia,[_name.estrelavermelha]];
    map[_name.cukaricki] = [ClubColors(Colors.white,Colors.black),Coordinates(44.7603344, 20.4245656),
      'Čukarički Stadion',7000,1926,_country.serbia,];
    map[_name.radnik] = [ClubColors(Colors.blue,Colors.blue),Coordinates(42.6924068, 22.1655271),
      'Surdulica City Stadium',3312,1926,_country.serbia,];
    map[_name.radnicki] = [ClubColors(Colors.red,Colors.red),Coordinates(43.31552, 21.9088012),
      'Čair Stadium',18151,1923,_country.serbia,];
    map[_name.vojvodina] = [ClubColors(Colors.red,Colors.white),Coordinates(45.24694, 19.8417566),
			'Stadium of Vojvodina',15754,1914,_country.serbia,];
    //BULGARIA
    map[_name.beroe] = [ClubColors(Colors.white,Colors.green),Coordinates(42.4326854, 25.61541325),
      'Estádio Beroe',12128,1916,_country.bulgaria,];
    map[_name.cskaSofia] = [ClubColors(Colors.white,Colors.red),Coordinates(42.6842594, 23.339714),
      'Balgarska Armiya Stadium',22015,1948,_country.bulgaria,];
    map[_name.levskiSofia] = [ClubColors(Colors.blue,Colors.blue),Coordinates(42.7054198, 23.3632712),
      'Georgi Aspraruhov',29980,1914,_country.bulgaria,];
    map[_name.lokplovdiv] = [ClubColors(Colors.red,Colors.black),Coordinates(42.1338578, 24.77161877),
			'Lokomotiv',11800,1926,_country.bulgaria,];
    map[_name.loksofia] = [ClubColors(Colors.red,Colors.black),Coordinates(42.737672, 23.314724),
      'Lokomotiv Stadium',22000,1929,_country.bulgaria,];
    map[_name.ludogorets] = [ClubColors(Colors.green,Colors.black),Coordinates(43.5344062, 26.5281217),
      'Ludogorets Arena',12500,1940,_country.bulgaria,];
    map[_name.slaviaSofia] = [ClubColors(Colors.white,Colors.black),Coordinates(42.675321, 23.27190),
      'Slavia Stadium',15992,1913,_country.bulgaria,];
    map[_name.spartakPlovdiv] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.bulgaria,];
    //CROATIA
    map[_name.dinamozagreb] = [ClubColors(Colors.red,Colors.blue),Coordinates(45.818673, 16.018165),
			'Maksimir',38923,1911,_country.croatia,];
    map[_name.gorica] = [ClubColors(Colors.white,Colors.red),Coordinates(45.7239381, 16.0730582),
      'Gradski stadion Velika Gorica',5200,2009,_country.croatia,];
    map[_name.hadjuksplit] = [ClubColors(Colors.red,Colors.white),Coordinates(43.5198462, 16.432361),
			'Polijud',35000,1911,_country.croatia,];
    map[_name.lokZagreb] = [ClubColors(Colors.blue,Colors.white),Coordinates(45.8045, 15.96078837),
      'Stadion Kranjčevićeva',8850,1914,_country.croatia,];
    map[_name.osijek] = [ClubColors(Colors.blue,Colors.white),Coordinates(45.5449856, 18.6955684),
    ...
    map[_name.brno] = [ClubColors(Colors.red,Colors.white),Coordinates(49.22719586, 16.586590),
			'Městský fotbalový Stadion Srbská',12550,1913,_country.czechRepublic,];
    map[_name.jablonec] = [ClubColors(Colors.green,Colors.white),Coordinates(50.715097, 15.16240467),
      'Stadion Střelnice',6280,1945,_country.czechRepublic,];
    map[_name.slaviaPraha] = [ClubColors(Colors.red,Colors.white),Coordinates(50.06761576, 14.4717161),
      'Stadion Eden',21000,1892,_country.czechRepublic,[_name.spartapraga]];
    map[_name.slovacko] = [ClubColors(Colors.blue,Colors.white),Coordinates(50.914364, 14.619126),
      'Městský fotbalový Miroslava Valenty',8121,1927,_country.czechRepublic,];
    map[_name.slovanLiberec] = [ClubColors(Colors.blue,Colors.white),Coordinates(50.77632357, 15.0500971),
      'Stadion u Nisy',10000,1921,_country.czechRepublic,];
    map[_name.spartapraga] = [ClubColors(grena,Colors.white),Coordinates(50.0999540, 14.41632580),
      'Generali Arena',20111,1893,_country.czechRepublic,[_name.slaviaPraha]];
    map[_name.teplice] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(50.6400542, 13.81769347),
      'Na Stínadlech',18221,1945,_country.czechRepublic,];
    map[_name.viktoriaPlzen] = [ClubColors(Colors.red,Colors.blue),Coordinates(49.7500716, 13.385528253),
			'Doosan Arena',12500,1911,_country.czechRepublic,];
    map[_name.dukla] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.czechRepublic,];
    map[_name.hradec] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.czechRepublic,];
    map[_name.vitkovice] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.czechRepublic,];
    //HUNGRIA
    ...
    //ROMENIA
    map[_name.argesPitesti] = [ClubColors(Colors.purple,Colors.white),Coordinates(44.8466756, 24.866616),
    ...
    map[_name.dinamoBucuresti] = [ClubColors(Colors.red,Colors.white),Coordinates(44.455083,26.102444),
			'Stadionul Dinamo',15300,1948,_country.romania,];
    map[_name.rapidBucuresti] = [ClubColors(grena,Colors.white),Coordinates(44.45708788, 26.05564517),
			'Estádio Giulești-Valentin Stănescu',19100,1929,_country.romania,];
    map[_name.steauaBucuresti] = [ClubColors(Colors.red,Colors.blue),Coordinates(44.43741937, 26.15314218),
      'Arena Națională',55634,1947,_country.romania,];
    map[_name.arad] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.romania,];
    map[_name.craiova] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.romania,];
    map[_name.otelul] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.romania,];
    map[_name.unirea] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.romania,];
    //ESLOVAQUIA
    map[_name.slovanBratislava] = [ClubColors(Colors.blue,Colors.white),Coordinates(48.1659626, 17.14220898),
			'Pasienky',30085,1919,_country.slovakia,];
    map[_name.interBratislava] = [ClubColors(Colors.yellow,Colors.black),Coordinates(48.1760430, 17.05031259),
			'Stadium ŠKP Inter Dúbravka',10200,1940,_country.slovakia,];
    map[_name.trnava] = [ClubColors(Colors.red,Colors.black),Coordinates(48.3736672, 17.5916824),
			'Štadión Antona Malatinského',18448,1923,_country.slovakia,];
    map[_name.zilina] = [ClubColors(Colors.green,Colors.yellow),Coordinates(49.229209, 18.7446925),
      'Štadión pod Dubňom',11258,1908,_country.slovakia,];
    map[_name.petrzalka] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.slovakia,];
    map[_name.kosice] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.slovakia,];

    //OUTROS
    //ALBANIA
    map[_name.tiranafk] = [ClubColors(Colors.blue,Colors.white),Coordinates(41.319399, 19.81133),
			'Selman Stermasi Stadium',7000,1920,_country.albania,];
    map[_name.laci] = [ClubColors(Colors.white,Colors.black),Coordinates(41.6424706, 19.711743),
      'Laçi Stadium',4500,1960,_country.albania,];
    map[_name.partizanitirane] = [ClubColors(Colors.red,Colors.white),Coordinates(41.3191655, 19.8114063),
      'Selman Stërmasi Stadium',20600,1946,_country.albania,];
    map[_name.vllaznia] = [ClubColors(Colors.red,Colors.white),Coordinates(42.07005, 19.5066547),
      'Loro-Boriçi Stadium',20300,1919,_country.albania,];
    //ESLOVENIA
    map[_name.celje] = [ClubColors(darkblue,Colors.blue),Coordinates(46.2465780, 15.2699934),
      'Arena Petrol',13006,1919,_country.slovenia,];
    map[_name.domzale] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(46.136925, 14.60178),
      'Športni Park',3212,1921,_country.slovenia,];
    map[_name.ljublijana] = [ClubColors(Colors.green,Colors.white),Coordinates(46.0804351, 14.524180),
    ...
    map[_name.mura] = [ClubColors(Colors.purple,Colors.yellow),Coordinates(46.6685624, 16.1575858),
      'Fazanerija',3782,2012,_country.slovenia,];
    //MACEDONIA
    map[_name.akaPandev] = [ClubColors(Colors.blue,Colors.white),Coordinates(41.437822, 22.768785),
      'Stadion Kukuš',1500,2010,_country.macedonia,];
    map[_name.shkendija] = [ClubColors(Colors.red,Colors.black),Coordinates(42.0186995, 20.97822),
      'Čair Stadium',15000,1979,_country.macedonia,];
    map[_name.shkupi] = [ClubColors(Colors.blue,Colors.blue),Coordinates(42.015522, 21.4446538),
      'Čair Stadium',6000,1927,_country.macedonia,];
    map[_name.vardar] = [ClubColors(Colors.red,Colors.black),Coordinates(42.0060954, 21.425804),
      'Nacional Arena Philip II Macedônia',24000,1947,_country.macedonia,];
    //BOSNIA
    map[_name.sarajevo] = [ClubColors(grena,Colors.white),Coordinates(43.87391863, 18.409078),
			'Estádio Asim Ferhatović Hase',35630,1946,_country.bosnia,];
    map[_name.zrinjski] = [ClubColors(Colors.white,darkblue),Coordinates(43.3456540, 17.795418),
			'Bijeli Brijeg Stadium',25000,1905,_country.bosnia,];
    //KOSOVO
    map[_name.ballkani] = [ClubColors(Colors.orange,Colors.black),Coordinates(42.38421140, 20.434450),
      'Suva Reka City Stadium',1500,1947,_country.kosovo,];
    map[_name.drita] = [ClubColors(Colors.blue,Colors.blue),Coordinates(42.46440065, 21.476240),
      '	Gjilan City Stadium',15000,1947,_country.kosovo,];
    map[_name.llapi] = [ClubColors(Colors.blue,Colors.white),Coordinates(42.90515045, 21.19488228),
      'Zahir Pajaziti Stadium',5000,1932,_country.kosovo,];
    map[_name.prishtina] = [ClubColors(Colors.blue,Colors.white),Coordinates(42.6628634, 21.15705135),
      'Estádio Pristina City',16200,1922,_country.kosovo,];
    //MONTENEGRO
    map[_name.podgorica] = [ClubColors(Colors.blue,Colors.white),Coordinates(42.44493750, 19.26417934),
    ...
    map[_name.jeunesseesch] = [ClubColors(Colors.black,Colors.white),Coordinates(49.48596292, 5.97704983),
    ...
    //ANDORRA
    map[_name.andorra] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(42.501271, 1.514),
      'Estadi Comunal',2000,1942,_country.andorra,];
    map[_name.santacoloma] = [ClubColors(Colors.white,Colors.red),Coordinates(42.500797, 1.5137064),
    ...
    map[_name.corinthians] = [ClubColors(Colors.white,Colors.black),Coordinates(-23.545555,-46.474),
    ...
    map[_name.flamengo] = [ClubColors(Colors.red,Colors.black),Coordinates(-22.911357, -43.230113),
			'Maracanã',78838,1895,_country.brazil,[_name.botafogo,_name.vasco,_name.fluminense]];
    map[_name.fluminense] = [ClubColors(Colors.red,Colors.green),Coordinates(-22.913116, -43.2303602),
    ...
    map[_name.internacional] = [ClubColors(Colors.red,Colors.white),Coordinates(-30.06485477, -51.23599),
    ...
    map[_name.brusque] = [ClubColors(Colors.yellow,Colors.red),Coordinates(-27.10126696, -48.916319),
      'Augusto Bauer',5000,1987,_country.brazil,];
    map[_name.cuiaba] = [ClubColors(Colors.green,Colors.yellow),Coordinates(-15.60186930, -56.121367),
			'Arena Pantanal',44097,2001,_country.brazil,];
    map[_name.chapecoense] = [ClubColors(Colors.red,Colors.white),Coordinates(-27.10339550, -52.6068313),
			'Arena Condá',22600,1973,_country.brazil,];
    map[_name.crb] = [ClubColors(Colors.red,Colors.white),Coordinates(-9.67054432, -35.75930852),
    ...
    map[_name.gremio] = [ClubColors(Colors.blue,Colors.black),Coordinates(-29.972884, -51.1949268),
    ...
    map[_name.guarani] = [ClubColors(Colors.green,Colors.white),Coordinates(-22.909782888, -47.043755),
    ...
    map[_name.tombense] = [ClubColors(Colors.red,Colors.white),Coordinates(-20.90766468, -42.030541527),
    ...
    map[_name.vitoria] = [ClubColors(Colors.red,Colors.black),Coordinates(-12.91850220, -38.42813070),
			'Barradão',30618,1899,_country.brazil,[_name.bahia]];

    map[_name.julho4] = [ClubColors(Colors.red,Colors.white),Coordinates(-4.27619893, -41.78598826),
      'Arena Ytacoatiara',8500,1987,_country.brazil,];
    map[_name.abc] = [ClubColors(Colors.white,Colors.black),Coordinates(-5.888405361, -35.17937587),
			'Frasqueirão',18000,1915,_country.brazil,];
    map[_name.aguasanta] = [ClubColors(Colors.blue,Colors.white),Coordinates(-23.723344, -46.612920),
      'Arena Inamar',10000,1981,_country.brazil,];
    map[_name.aguiamaraba] = [ClubColors(Colors.blue,Colors.white),Coordinates(-5.3520618, -49.1383246157),
			'Zinho de Oliveira',4500,1982,_country.brazil,];
    map[_name.altos] = [ClubColors(Colors.green,Colors.green),Coordinates(-5.038122163, -42.44551040),
      'Felipão',4000,2013,_country.brazil,];
    map[_name.amazonas] = [ClubColors(Colors.yellow,Colors.black),Coordinates(-3.0844007, -59.9838851),
    ...
    map[_name.avai] = [ClubColors(Colors.blue,Colors.white),Coordinates(-27.66578267, -48.53165186),
      'Ressacada',17800,1923,_country.brazil,];
    map[_name.azuriz] = [ClubColors(darkblue,Colors.white),Coordinates(-26.2110895, -52.679588977),
    ...
    map[_name.bangu] = [ClubColors(Colors.red,Colors.white),Coordinates(-22.8719064, -43.456439277),
      'Moça Bonita',9500,1904,_country.brazil,];
    map[_name.boavistaRJ] = [ClubColors(Colors.green,Colors.white),Coordinates(-22.8954655, -42.4771417),
    ...
    map[_name.brasilia] = [ClubColors(Colors.red,Colors.white),Coordinates(-15.78318347, -47.8993050727),
    ...
    map[_name.brasilPelotas] = [ClubColors(Colors.red,Colors.black),Coordinates(-31.7712377, -52.332841550),
      'Bento Freitas',10200,1911,_country.brazil,];
    map[_name.camboriu] = [ClubColors(Colors.orange,Colors.green),Coordinates(-27.0214440, -48.64794059),
      'Robertão',3500,2003,_country.brazil,];
    map[_name.campinense] = [ClubColors(Colors.red,Colors.black),Coordinates(-7.25366757188, -35.88033665),
    ...
    map[_name.caxias] = [ClubColors(Colors.red,Colors.blue),Coordinates(-29.1649520, -51.1964163918332),
    ...
    map[_name.cianorte] = [ClubColors(Colors.white,Colors.black),Coordinates(-23.66138978, -52.5938666),
			'Albino Turbay',4000,1993,_country.brazil,];
    map[_name.comercial] = [ClubColors(Colors.white,Colors.black),Coordinates(-21.1865312, -47.788333),
			'Estádio Palma Travassos',18277,1911,_country.brazil,];
    map[_name.confianca] = [ClubColors(Colors.blue,Colors.white),Coordinates(-10.8944975, -37.0538261),
			'Sabino Ribeiro',3000,1936,_country.brazil,];
    map[_name.desportiva] = [ClubColors(grena,Colors.white),Coordinates(-20.33414206, -40.3561058),
    ...
    map[_name.fast] = [ClubColors(Colors.white,Colors.white),Coordinates(-3.12155505, -60.03779047),
      'Colina',10000,1930,_country.brazil,];
    map[_name.ferroviaria] = [ClubColors(grena,Colors.black),Coordinates(-21.7750702, -48.1701263),
			'Fonte Luminosa',20000,1950,_country.brazil,];
    map[_name.gama] = [ClubColors(grena,Colors.white),Coordinates(-16.01127196, -48.06133544),
			'Bezerrão',20310,1975,_country.brazil,[_name.brasiliense]];
    map[_name.globo] = [ClubColors(Colors.white,Colors.black),Coordinates(-5.6489411, -35.46004640),
			'Barretão',10000,2012,_country.brazil,];
    map[_name.goytacaz] = [ClubColors(Colors.blue,Colors.white),Coordinates(-21.76202402, -41.31634627),
			'Ary de Oliveira e Souza',15000,1912,_country.brazil,];
    map[_name.ibis] = [ClubColors(Colors.red,Colors.black),Coordinates(-7.963256319, -34.840713),
    ...
    map[_name.ipatinga] = [ClubColors(Colors.green,Colors.red),Coordinates(-19.470869944, -42.541159),
			'Ipatingão',22000,1998,_country.brazil,];
    map[_name.itabaiana] = [ClubColors(Colors.blue,Colors.red),Coordinates(-10.68849961, -37.4319),
      'Etelvino Mendonça',12000,1938,_country.brazil,];
    map[_name.ituano] = [ClubColors(Colors.red,Colors.black),Coordinates(-23.2803369, -47.287407674),
			'Novelli Júnior',16749,1947,_country.brazil,];
    map[_name.joinville] = [ClubColors(Colors.red,Colors.black),Coordinates(-26.31645224, -48.83343633),
			'Arena Joinville',22100,1976,_country.brazil,];
    map[_name.juventusMooca] = [ClubColors(grena,Colors.white),Coordinates(-23.5531052, -46.60451048),
			'Estádio Conde Rodolfo Crespi',5000,1924,_country.brazil,];
    map[_name.linense] = [ClubColors(Colors.red,Colors.white),Coordinates(-21.666501905, -49.763218818),
			'Gilbertão',15770,1927,_country.brazil,];
    map[_name.luverdense] = [ClubColors(Colors.green,Colors.white),Coordinates(-13.07439827, -55.923762246),
    ...
    map[_name.madureira] = [ClubColors(Colors.purple,Colors.yellow),Coordinates(-22.869530143, -43.337035425),
			'Conselheiro Galvão',5014,1914,_country.brazil,];
    map[_name.manaus] = [ClubColors(Colors.green,Colors.black),Coordinates(-3.082731444, -60.02706630),
			'Arena da Amazônia',44000,2013,_country.brazil,];
    map[_name.marilia] = [ClubColors(Colors.white,Colors.blue),Coordinates(-22.21940335, -49.93949715),
    ...
    map[_name.mogimirim] = [ClubColors(Colors.red,Colors.white),Coordinates(-22.439263926, -46.9617167107),
    ...
    map[_name.nacionalAM] = [ClubColors(Colors.blue,Colors.white),Coordinates(-3.084092564, -60.02796159),
      'Arena da Amazônia',44000,2013,_country.brazil,];
    map[_name.nacionalSP] = [ClubColors(Colors.blue,Colors.white),Coordinates(-23.5180334948, -46.6851971843),
    ...
    map[_name.novaiguacu] = [ClubColors(Colors.orange,Colors.black),Coordinates(-22.74785706, -43.460851929),
			'Jânio Moraes',4700,1990,_country.brazil,];
    map[_name.novohamburgo] = [ClubColors(Colors.blue,Colors.white),Coordinates(-29.7262180, -51.143800),
      'Estádio do Vale',5196,1911,_country.brazil,];
    map[_name.oeste] = [ClubColors(Colors.red,Colors.black),Coordinates(-23.51223575, -46.89928345),
    ...
    map[_name.paulista] = [ClubColors(Colors.black,Colors.white),Coordinates(-23.1880264, -46.8597525),
    ...
    map[_name.portovelho] = [ClubColors(Colors.black,Colors.white),Coordinates(-8.75714855, -63.9105997),
    ...
    map[_name.portuguesaRJ] = [ClubColors(Colors.white,Colors.white),Coordinates(-22.8016378, -43.2078454),
      'Luso-Brasileiro',6437,1924,_country.brazil,];
    map[_name.portuguesasantista] = [ClubColors(Colors.red,Colors.green),Coordinates(-23.94715573, -46.3372746),
      'Ulrico Mursa',7635,1917,_country.brazil,];
    map[_name.princesasolimoes] = [ClubColors(Colors.red,Colors.white),Coordinates(-3.283451615, -60.6316817),
    ...
    map[_name.resende] = [ClubColors(Colors.white,Colors.black),Coordinates(-22.4638346, -44.456106),
      'Estádio do Trabalhador',7500,1909,_country.brazil,];
    map[_name.retro] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(-8.040662488, -35.00816974),
    ...
    map[_name.riobrancoAC] = [ClubColors(Colors.red,Colors.white),Coordinates(-9.97037785, -67.8079834),
      'José de Melo',6000,1919,_country.brazil,];
    map[_name.riobrancoES] = [ClubColors(Colors.black,Colors.white),Coordinates(-20.33280029, -40.38518316),
      'Kleber Andrade',21000,1913,_country.brazil,];
    map[_name.riobrancoSP] = [ClubColors(Colors.white,Colors.black),Coordinates(-22.734535, -47.3479962),
      'Décio Vitta',16300,1913,_country.brazil,];
    map[_name.rioclaro] = [ClubColors(Colors.blue,Colors.white),Coordinates(-22.4223454, -47.56188026),
    ...
    map[_name.saobernardo] = [ClubColors(Colors.yellow,Colors.black),Coordinates(-23.699738, -46.55637),
    ...
    map[_name.saojose] = [ClubColors(Colors.white,Colors.blue),Coordinates(-23.1884290, -45.8698296),
    ...
    map[_name.saoraimundoRR] = [ClubColors(Colors.blue,Colors.white),Coordinates(2.818876055, -60.7208497),
      'Ribeirão',3000,1963,_country.brazil,];
    map[_name.serra] = [ClubColors(Colors.red,Colors.black),Coordinates(-20.12764236, -40.304361721),
    ...
    map[_name.sobradinho] = [ClubColors(Colors.black,Colors.white),Coordinates(-15.6526257, -47.7852544),
      'Augustinho Lima',10000,1975,_country.brazil,];
    map[_name.sousa] = [ClubColors(Colors.green,Colors.white),Coordinates(-6.7559593, -38.2232163),
      'Marizão',12400,1991,_country.brazil,];
    map[_name.taubate] = [ClubColors(Colors.blue,Colors.white),Coordinates(-23.02785, -45.57043134),
			'Joaquinzão',10000,1914,_country.brazil,];
    map[_name.tocantinopolis] = [ClubColors(Colors.green,Colors.white),Coordinates(-6.3429743, -47.4276875),
      'João Ribeiro',8000,1989,_country.brazil,];
    map[_name.trem] = [ClubColors(Colors.red,Colors.black),Coordinates(0.0006848359, -51.0808365),
    ...
    map[_name.urt] = [ClubColors(Colors.blue,Colors.white),Coordinates(-18.596822, -46.52139941),
    ...
    map[_name.ypirangaAP] = [ClubColors(Colors.blue,Colors.black),Coordinates(0.000243024, -51.08084246),
      'Zerão',13680,1963,_country.brazil,];
    map[_name.ypirangaRS] = [ClubColors(Colors.yellow,Colors.green),Coordinates(-27.65131147, -52.26477924),
    ...
    map[_name.arsenalsarandi] = [ClubColors(Colors.blue,Colors.red),Coordinates(-34.678230933, -58.3403085),
			'Julio Humberto Grondona',18500,1957,_country.argentina,];
    map[_name.banfield] = [ClubColors(Colors.green,Colors.white),Coordinates(-34.7506503, -58.38785437),
			'Florencio Sola',34901,1896,_country.argentina,];
    map[_name.barracas] = [ClubColors(Colors.red,Colors.white),Coordinates(-34.6474769, -58.39680),
      'Claudio Fabián Tapia',2700,1904,_country.argentina,];
    map[_name.belgrano] = [ClubColors(Colors.blue,Colors.white),Coordinates(-31.40324361, -64.2064250),
			'Gigante de Alberdi',30000,1905,_country.argentina,];
    map[_name.bocajuniors] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(-34.6350100, -58.3649280),
    ...
    map[_name.chacarita] = [ClubColors(Colors.red,Colors.black),Coordinates(-34.567153367, -58.52778112),
			'Chacarita Juniors',10000,1906,_country.argentina,];
    map[_name.chaco] = [ClubColors(Colors.black,Colors.white),Coordinates(0,0),
      'Sarmiento de Resistência',20000,1913,_country.argentina,];
    map[_name.colon] = [ClubColors(Colors.red,Colors.black),Coordinates(-31.6625043, -60.72494809),
			'Brigadier General Estanislao López',40000,1905,_country.argentina,];
    map[_name.defensayjusticia] = [ClubColors(Colors.yellow,Colors.green),Coordinates(-34.8212666, -58.28582255),
    ...
    map[_name.riverplate] = [ClubColors(Colors.white,Colors.red),Coordinates(-34.54518243, -58.44934575),
			'Monumental de Núñez',70074,1901,_country.argentina,[_name.bocajuniors]];
    map[_name.rosariocentral] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(-32.9138952, -60.6744748),
    ...
    map[_name.sarmiento] = [ClubColors(Colors.green,Colors.white),Coordinates(-34.58532867, -60.92932811),
    ...
    map[_name.temperley] = [ClubColors(Colors.blue,Colors.white),Coordinates(-34.78171364, -58.40013736),
    ...
    map[_name.cerrouru] = [ClubColors(Colors.lightBlueAccent,Colors.white),Coordinates(-34.867238122, -56.25201598),
      'Luis Trócolli',25000,1922,_country.uruguay,];
    map[_name.danubio] = [ClubColors(Colors.white,Colors.black),Coordinates(-34.8387170, -56.13208784),
    ...
    map[_name.fenix] = [ClubColors(Colors.purple,Colors.white),Coordinates(-34.87338535, -56.212268),
			'Parque Capurro',10000,1916,_country.uruguay,];
    map[_name.liverpoolURU] = [ClubColors(Colors.blue,Colors.red),Coordinates(-34.8549854, -56.225665),
    ...
    map[_name.plazacolonia] = [ClubColors(Colors.white,Colors.green),Coordinates(-34.46715174, -57.8456522),
      'Prof. Alberto Suppici',12000,1917,_country.uruguay,];
    map[_name.rentistas] = [ClubColors(Colors.red,Colors.white),Coordinates(-34.776324, -56.165855),
			'Complejo Rentistas',10600,1933,_country.uruguay,];
    map[_name.riverURU] = [ClubColors(Colors.red,Colors.white),Coordinates(-34.861929, -56.201579),
    ...
    map[_name.bellavista] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.uruguay,];
    map[_name.progreso] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.uruguay,];
    map[_name.rocha] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.uruguay,];
    ...
    map[_name.tacuary] = [ClubColors(Colors.white,Colors.black),Coordinates(-25.2831537, -57.606315),
    ...
    map[_name.curico] = [ClubColors(Colors.yellow,Colors.black),Coordinates(-34.9742154, -71.230767),
    ...
    map[_name.huachipato] = [ClubColors(Colors.blue,Colors.black),Coordinates(-36.75502733, -73.10760524),
    ...
    map[_name.laserena] = [ClubColors(grena,Colors.white),Coordinates(-29.911299, -71.251873),
    ...
    map[_name.nublense] = [ClubColors(Colors.red,Colors.red),Coordinates(-36.618249, -72.107945),
    ...
    map[_name.palestino] = [ClubColors(Colors.red,Colors.green),Coordinates(-33.5202176734, -70.67294633),
    ...
    map[_name.univcatolica] = [ClubColors(Colors.blue,Colors.white),Coordinates(-33.39498660, -70.5005379),
      'San Carlos de Apoquindo',14768,1937,_country.chile,];
    map[_name.lau] = [ClubColors(Colors.blue,Colors.white),Coordinates(-33.464054, -70.61059),
    ...
    map[_name.concepcion] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.chile,];
    map[_name.rangersCHI] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.chile,];
    map[_name.sanfelipe] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.chile,];

    map[_name.alwaysReady] = [ClubColors(Colors.red,Colors.white),Coordinates(-16.4994122, -68.12262946),
			'Hernando Siles',42000,1933,_country.bolivia,];
    map[_name.aurora] = [ClubColors(Colors.blue,Colors.white),Coordinates(-17.37968516, -66.1615046),
			'Félix Capriles',32000,1935,_country.bolivia,];
    map[_name.bolivar] = [ClubColors(Colors.blue,Colors.white),Coordinates(-16.499412183054098, -68.12263),
    ...
    map[_name.indPetrolero] = [ClubColors(Colors.red,Colors.white),Coordinates(-17.34287, -63.261564),
    ...
    map[_name.nacionalpotosi] = [ClubColors(Colors.white,Colors.green),Coordinates(-19.5793537, -65.7616416),
      'Víctor Agustín Ugarte',32105,1942,_country.bolivia,];
    map[_name.orientePetrolero] = [ClubColors(Colors.white,Colors.green),Coordinates(-19.0332323, -65.257856),
			'Estádio Ramón Tahuichi Aguilera',38500,1955,_country.bolivia,];
    map[_name.palmaflor] = [ClubColors(Colors.green,Colors.yellow),Coordinates(-17.3920347, -66.275128),
      'Municipal de Quillacollo',5000,2008,_country.bolivia,];
    map[_name.realsantacruz] = [ClubColors(Colors.white,Colors.white),Coordinates(-17.8058075, -63.1661464),
      'Juan Carlos Durán',15000,1962,_country.bolivia,];
    map[_name.royalpari] = [ClubColors(Colors.red,Colors.red),Coordinates(-17.795543, -63.183247),
    ...
    map[_name.theStrongest] = [ClubColors(Colors.yellow,Colors.black),Coordinates(-16.499412, -68.12263),
    ...
    map[_name.litoral] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.bolivia,];
    map[_name.octubre31] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.bolivia,];

    map[_name.alianzalima] = [ClubColors(Colors.blue,Colors.white),Coordinates(-12.06765595, -77.0229485),
			'Alejandro Villanueva',35000,1901,_country.peru,];
    map[_name.binacional] = [ClubColors(Colors.lightBlueAccent,Colors.blue),Coordinates(-15.502587, -70.1233308),
      'Guillermo Briceño Rosamedina',20030,2010,_country.peru,];
    map[_name.carlosmanucci] = [ClubColors(Colors.blue,Colors.blue),Coordinates(-8.1062, -79.03067),
      'Mansiche',25000,1959,_country.peru,];
    map[_name.cesarvallejo] = [ClubColors(Colors.orange,darkblue),Coordinates(-8.10611593, -79.030676),
      'Mansiche',25000,1996,_country.peru,];
    map[_name.cienciano] = [ClubColors(Colors.red,Colors.white),Coordinates(-13.5242097, -71.966351907),
    ...
    map[_name.juanaurich] = [ClubColors(Colors.red,Colors.white),Coordinates(-6.76763163, -79.86207526),
      'Elías Aguirre',25000,1922,_country.peru,];
    map[_name.melgar] = [ClubColors(Colors.red,Colors.black),Coordinates(-16.40644668, -71.5202360),
    ...
    map[_name.sportingcristal] = [ClubColors(Colors.blue,Colors.white),Coordinates(-12.0362617, -77.045132758),
      'Alberto Gallardo',11600,1955,_country.peru,];
    map[_name.huancayo] = [ClubColors(Colors.pink,Colors.black),Coordinates(-12.072618, -75.201664),
      'Estádio Huancayo',17000,2007,_country.peru,];
    map[_name.universitario] = [ClubColors(Colors.white,Colors.red),Coordinates(-12.055024119, -76.9358871764),
      'Monumental de Lima',80093,1924,_country.peru,];
    map[_name.unisanmartin] = [ClubColors(Colors.white,Colors.black),Coordinates(-12.06730518, -77.0336576),
      'Nacional de Lima',45000,2004,_country.peru,];
    map[_name.chalaco] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.peru,];
    map[_name.atltorino] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.peru,];
    map[_name.arica] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.peru,]; //EXTINTO
    map[_name.ugarte] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.peru,];
    map[_name.coronel] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.peru,];
    map[_name.defensorlima] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.peru,];
    map[_name.leonhuanuco] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.peru,];
    map[_name.sanagustin] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estadio Nacional',45000,1970,_country.peru,]; //EXISTE, MAS FORA DO SISTEMA DE LIGAS
    map[_name.univtecnica] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.peru,];
    map[_name.unionhuaral] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.peru,];

    map[_name.aucas] = [ClubColors(Colors.yellow,Colors.red),Coordinates(-0.2789491, -78.546213),
      'Gonzalo Pozo Ripalda',20000,1945,_country.ecuador,];
    map[_name.barcelonaequ] = [ClubColors(Colors.yellow,Colors.red),Coordinates(-2.18560555, -79.924764),
			'Monumental Isidro Romero Carbo',57267,1925,_country.ecuador,];
    map[_name.delfin] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(-0.964043321, -80.702654),
    ...
    map[_name.depquito] = [ClubColors(Colors.blue,Colors.red),Coordinates(-0.1777998, -78.47661),
			'Olímpico Atahualpa',40948,1940,_country.ecuador,];
    map[_name.emelec] = [ClubColors(Colors.blue,Colors.white),Coordinates(-2.20565402, -79.893875),
    ...
    map[_name.guayaquil] = [ClubColors(Colors.lightBlueAccent,Colors.blue),Coordinates(-2.1028473, -79.903678),
      'Christian Benítez Betancourt',8000,2007,_country.ecuador,];
    map[_name.idelvalle] = [ClubColors(Colors.blue,Colors.black),Coordinates(-0.34883621, -78.4708232),
      'Rumiñahui',10233,1958,_country.ecuador,];
    map[_name.ldu] = [ClubColors(Colors.white,Colors.grey),Coordinates(-0.10660691, -78.48884),
      'Rodrigo Paz Delgado',41575,1918,_country.ecuador,];
    map[_name.macara] = [ClubColors(Colors.lightBlueAccent,Colors.blue),Coordinates(-1.24482626, -78.623129),
      'Rodrigo Paz Delgado',16467,1939,_country.ecuador,];
    map[_name.mushucruna] = [ClubColors(grena,Colors.green),Coordinates(-1.30916165, -78.7278448),
      'Estádio Mushuc Runa COAC',6000,2003,_country.ecuador,];
    map[_name.olmedo] = [ClubColors(Colors.blue,Colors.red),Coordinates(-1.6662906, -78.6604288),
    ...
    map[_name.espoli] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.ecuador,];
    map[_name.americaquito] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.ecuador,];
    map[_name.everestGuayaquil] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.ecuador,];
    map[_name.filanbanco] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.ecuador,];
    map[_name.nueveoctubre] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.ecuador,];
    map[_name.tecnicoUniv] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.ecuador,];
    map[_name.valdez] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.ecuador,];

    map[_name.alianzaPetrolera] = [ClubColors(Colors.yellow,Colors.black),Coordinates(7.073057, -73.864671),
      'Daniel Villa Zapata',10400,1991,_country.colombia,];
    map[_name.americadecali] = [ClubColors(Colors.red,Colors.white),Coordinates(3.43076413, -76.5409550),
    ...
    map[_name.bucaramanga] = [ClubColors(Colors.white,Colors.white),Coordinates(7.136745, -73.116192),
    ...
    map[_name.deportivocali] = [ClubColors(Colors.green,Colors.white),Coordinates(3.52269250, -76.41571171),
      'Estádio Deportivo Cali',55000,1912,_country.colombia,];
    map[_name.depPasto] = [ClubColors(Colors.red,Colors.blue),Coordinates(1.19825378, -77.2778826),
      'Departamental Libertad',20700,1949,_country.colombia,];
    map[_name.envigado] = [ClubColors(Colors.orange,Colors.green),Coordinates(6.16451557, -75.5989182),
      'Polideportivo Sur',12000,1989,_country.colombia,];
    map[_name.junior] = [ClubColors(Colors.red,Colors.white),Coordinates(10.927145429567, -74.8000172),
      'Metropolitano',46692,1924,_country.colombia,];
    map[_name.imedellin] = [ClubColors(Colors.red,Colors.blue),Coordinates(6.256939271, -75.5898773),
      'Atanasio Girardot',45953,1913,_country.colombia,];
    map[_name.laequidad] = [ClubColors(Colors.white,Colors.green),Coordinates(4.62375432, -74.1354781),
    ...
    map[_name.patriotas] = [ClubColors(Colors.red,Colors.green),Coordinates(5.5421279, -73.353390),
      'La Independencia',21000,2003,_country.colombia,];
    map[_name.pereira] = [ClubColors(Colors.red,Colors.yellow),Coordinates(4.80468765, -75.751995),
      'Hernán Villegas',30313,1944,_country.colombia,];
    map[_name.rioNegroAguilas] = [ClubColors(Colors.amberAccent,Colors.black),Coordinates(6.14667896, -75.372829),
    ...
    map[_name.boyaca] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.colombia,];
    map[_name.cortulua] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.colombia,];
    map[_name.uMagdalena] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.colombia,];

    map[_name.carabobo] = [ClubColors(grena,Colors.white),Coordinates(10.2230961, -68.0115140),
      'Estádio Misael Delgado',14000,1964,_country.venezuela,];
    map[_name.caracas] = [ClubColors(Colors.red,Colors.white),Coordinates(10.49220252, -66.885644393),
			'Estádio Olímpico de Caracas',24900,1967,_country.venezuela,];
    map[_name.laGuaira] = [ClubColors(Colors.white,Colors.blue),Coordinates(10.492202523, -66.885644393),
    ...
    map[_name.metropolitanos] = [ClubColors(Colors.blue,Colors.black),Coordinates(10.482750, -66.941810),
    ...
    map[_name.minerven] = [ClubColors(Colors.blue,Colors.black),Coordinates(7.3472689, -61.82695),
			'Héctor Thomas',5000,1985,_country.venezuela,];
    map[_name.portuguesaven] = [ClubColors(Colors.red,Colors.black),Coordinates(9.570767650, -69.21027962),
    ...
    map[_name.anzoategui] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.venezuela,];
    map[_name.depitalia] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.venezuela,];
    map[_name.depgalicia] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.venezuela,];
    map[_name.laraFC] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.venezuela,];
    map[_name.maracaibo] = [ClubColors(Colors.blue,Colors.red),Coordinates(0,0),
      'José Pachencho Romero',35000,2001,_country.venezuela,]; //FALENCIA
    map[_name.margarita] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.venezuela,];
    map[_name.maritimoven] = [ClubColors(Colors.red,Colors.black),Coordinates(0,0),
      'Estádio',0,0,_country.venezuela,];
    map[_name.pepeganga] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.venezuela,];
    map[_name.portugues] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.venezuela,];
    map[_name.sancristobal] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.venezuela,];
    map[_name.uCanarias] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.venezuela,];//EXTINTO
    map[_name.ula] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.venezuela,];
    map[_name.valenciaven] = [ClubColors(Colors.red,Colors.black),Coordinates(0, 0),
      'Estádio',0,0,_country.venezuela,];
    ...
    //USA
    map[_name.atlanta] = [ClubColors(Colors.red,Colors.black),Coordinates(33.75535771, -84.40062064),
			'Mercedes-Benz Stadium',72035,2014,_country.unitedStates,];
    map[_name.austin] = [ClubColors(Colors.black,Colors.green),Coordinates(30.38794963, -97.7192678),
			'Q2 Stadium',20738,2019,_country.unitedStates,];
    map[_name.minnesota] = [ClubColors(Colors.blue,Colors.grey),Coordinates(44.95329071, -93.16552316),
			'Allianz Field',19400,2010,_country.unitedStates,];
    map[_name.cincinnati] = [ClubColors(Colors.blue,Colors.orange),Coordinates(39.1110140, -84.522226),
      'West End Stadium',26000,2015,_country.unitedStates,];
    map[_name.columbuscrew] = [ClubColors(Colors.yellow,Colors.black),Coordinates(40.009552335, -82.9910362),
			'Mapfre Stadium',19968,1994,_country.unitedStates,];
    map[_name.charlotte] = [ClubColors(Colors.blue,Colors.white),Coordinates(35.225876, -80.852819),
    ...
    map[_name.nashville] = [ClubColors(Colors.yellow,darkblue),Coordinates(36.1301689, -86.7658585),
      'Geodis Park',30000,2016,_country.unitedStates,];
    map[_name.nerevolution] = [ClubColors(Colors.blue,Colors.red),Coordinates(42.091105, -71.264239),
    ...
    map[_name.sportingKansasCity] = [ClubColors(Colors.lightBlueAccent,darkblue),Coordinates(39.12169273, -94.82291920),
			'Children\'s Mercy Park',18467,1995,_country.unitedStates,];
    map[_name.vancouver] = [ClubColors(darkblue,Colors.lightBlueAccent),Coordinates(49.2770509, -123.1119131),
			'BC Place',54500,2009,_country.canada,];

    //CANADA
    map[_name.cavalry] = [ClubColors(Colors.red,Colors.white),Coordinates(50.8840803, -114.0987956),
      'ATCO Field',6000,2018,_country.canada,];
    map[_name.forge] = [ClubColors(Colors.orange,Colors.white),Coordinates(43.25220, -79.83009),
    ...
    map[_name.alajuelense] = [ClubColors(Colors.black,Colors.red),Coordinates(10.0218617, -84.20910),
    ...
    map[_name.herediano] = [ClubColors(Colors.red,Colors.yellow),Coordinates(9.99945, -84.12303),
      'Eladio Rosabal Cordero',17895,1921,_country.costaRica,];
    map[_name.sanCarlos] = [ClubColors(darkblue,Colors.red),Coordinates(10.32398660, -84.423708),
      'Estádio Carlos Ugalde Álvarez',6200,1965,_country.costaRica,];
    map[_name.sptSanJose] = [ClubColors(Colors.black,Colors.white),Coordinates(9.94251970, -84.13030),
      'Ernesto Rohrmoser Stadium',3000,2016,_country.costaRica,];
    //HONDURAS
    map[_name.marathon] = [ClubColors(Colors.green,Colors.red),Coordinates(15.47014392, -88.00675),
      'Estadio Olímpico Metropolitano',45000,1925,_country.honduras,];
    map[_name.motagua] = [ClubColors(Colors.blue,darkblue),Coordinates(14.098298, -87.2039269),
      'Tiburcio Carias Andino',35000,1928,_country.honduras,];
    map[_name.olimpiaHON] = [ClubColors(Colors.white,Colors.red),Coordinates(14.09869, -87.203603),
			'Tiburcio Carias Andino',30000,1965,_country.honduras,];
    map[_name.rcdespana] = [ClubColors(Colors.yellow,Colors.red),Coordinates(15.507659, -88.033096),
			'Francisco Morazán',26781,1929,_country.honduras,];
    //PANAMA
    map[_name.alianzaPAN] = [ClubColors(Colors.green,Colors.white),Coordinates(9.03394, -79.470226),
    ...
    map[_name.independienteChorrera] = [ClubColors(Colors.yellow,Colors.black),Coordinates(8.8873752, -79.775471),
      'Agustín Muquita Sánchez',3000,1982,_country.panama,];
    map[_name.plazaAmador] = [ClubColors(Colors.blue,Colors.red),Coordinates(8.945835, -79.549585),
    ...
    //GUATEMALA
    map[_name.antiguaGuatemala] = [ClubColors(Colors.green,Colors.white),Coordinates(14.5673481, -90.7381967),
    ...
    map[_name.municipal] = [ClubColors(Colors.red,Colors.blue),Coordinates(14.62516724, -90.5101396),
      'Doroteo Guamuch Flores',26000,1936,_country.guatemala,];
    map[_name.xelaju] = [ClubColors(Colors.red,Colors.blue),Coordinates(14.842098, -91.51714438),
      'Mario Camposeco',11000,1928,_country.guatemala,];
    //EL SALVADOR
    map[_name.alianzaELS] = [ClubColors(Colors.white,Colors.white),Coordinates(13.6811446, -89.222373),
      'Estadio Cuscatlán',53400,1958,_country.elsalvador,];
    map[_name.atleticomarte] = [ClubColors(Colors.blue,Colors.white),Coordinates(13.6812, -89.2224),
    ...
    map[_name.isidro] = [ClubColors(Colors.white,Colors.blue),Coordinates(14.332095, -89.44904),
      'Jorge "Calero" Suárez',2000,2000,_country.elsalvador,];
    //NICARAGUA
    map[_name.diriangen] = [ClubColors(Colors.white,Colors.blue),Coordinates(11.8612898, -86.2433238),
      'Estadio Cacique Diriangén',7500,1917,_country.nicaragua,];
    map[_name.managua] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(12.131400, -86.284694),
      'Olímpico del IND Managua',9000,2006,_country.nicaragua,];
    map[_name.realEsteli] = [ClubColors(Colors.red,Colors.white),Coordinates(13.097860, -86.352943),
      'Estadio Independencia',5000,1961,_country.nicaragua,];
    //CUBA
    map[_name.pinardelrio] = [ClubColors(Colors.green,Colors.yellow),Coordinates(22.421594, -83.69040778),
      'Estadio Capitán San Luis',8000,1978,_country.cuba,];
    map[_name.santiagoCuba] = [ClubColors(Colors.blue,Colors.black),Coordinates(20.0365537, -75.81123),
      'Pista de Atletismo de Rekortan',5000,0,_country.cuba,];
    map[_name.villaclara] = [ClubColors(Colors.yellow,Colors.red),Coordinates(22.40494586, -79.950525),
			'Augusto César Sandino',18000,1978,_country.cuba,];
    //HAITI
    map[_name.arcahaie] = [ClubColors(Colors.blue,Colors.red),Coordinates(18.5585818, -72.3217),
      'Parc Saint-Yves',1000,2017,_country.haiti,];
    map[_name.donBosco] = [ClubColors(Colors.yellow,Colors.black),Coordinates(18.5189640, -72.2777613),
      'Stade Pétion-Ville',5000,1963,_country.haiti,];
    map[_name.fica] = [ClubColors(Colors.yellow,Colors.red),Coordinates(19.75364810, -72.20763375),
      'Parc Saint-Victor',7500,1972,_country.haiti,];
    map[_name.racingHAITI] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(18.53614276, -72.34248),
    ...
    //JAMAICA
    map[_name.arnettGardens] = [ClubColors(Colors.red,Colors.black),Coordinates(17.9889844, -76.79935),
      'Anthony Spaulding Sports Complex',7000,1977,_country.jamaica,];
    map[_name.harbourView] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(17.9565928, -76.717187),
      'Harbour View Stadium',10000,1974,_country.jamaica,];
    map[_name.portmore] = [ClubColors(Colors.blue,Colors.white),Coordinates(17.99285, -76.950748),
      'Prison Oval',2000,1985,_country.jamaica,];
    map[_name.tivoliGardens] = [ClubColors(Colors.orange,Colors.black),Coordinates(17.9705540, -76.799638),
      'Edward Seaga Sports Complex',5000,1970,_country.jamaica,];
    map[_name.waterhouse] = [ClubColors(Colors.lightBlueAccent,Colors.yellow),Coordinates(18.0013607, -76.77260),
    ...
    map[_name.police] = [ClubColors(Colors.blue,Colors.black),Coordinates(10.30349244, -61.4417926),
      'Manny Ramjohn Stadium',10000,1975,_country.trinidadTobago,];
    //SURINAME
    map[_name.robinhood] = [ClubColors(Colors.red,Colors.green),Coordinates(5.8376520, -55.1602422),
			'André Kamperveen Stadion',6000,1945,_country.suriname,];
    map[_name.transvaal] = [ClubColors(Colors.green,Colors.black),Coordinates(5.8377, -55.160),
    ...
    map[_name.changchun] = [ClubColors(Colors.red,Colors.black),Coordinates(43.836849, 125.39063),
      'Development Area Stadium',25000,1996,_country.china,];
    map[_name.chengdu] = [ClubColors(Colors.red,Colors.white),Coordinates(30.97869, 103.648159),
    ...
    map[_name.meizhou] = [ClubColors(Colors.red,Colors.blue),Coordinates(23.914710, 115.765430),
      'Huitang Stadium',27000,2013,_country.china,];
    map[_name.nantong] = [ClubColors(Colors.blue,Colors.blue),Coordinates(32.376731, 120.584843),
      'Rugao Olympic Sports Center',15000,2016,_country.china,];
    //map[_name.liaoning] = [ClubColors(Colors.red,Colors.red),Coordinates(41.73902122, 123.4574396),
    //  'Olímpico de Shenyang',60000,1953,_country.china,];
    map[_name.shandong] = [ClubColors(Colors.orange,Colors.white),Coordinates(36.6569476, 117.116563),
    ...
    map[_name.shanghaishenhua] = [ClubColors(Colors.blue,Colors.red),Coordinates(31.2734280, 121.476465),
			'Hongkou Stadium',33060,1993,_country.china,];
    map[_name.shenzhen] = [ClubColors(Colors.red,Colors.white),Coordinates(22.5620751, 114.0869843),
      'Luneng Stadium',32500,1994,_country.china,];
    map[_name.tianjin] = [ClubColors(Colors.red,Colors.white),Coordinates(39.03144590, 117.7252421),
			'TEDA Football Stadium',37450,1957,_country.china,];
    map[_name.wuhan] = [ClubColors(Colors.orange,Colors.white),Coordinates(30.58665415, 114.27357162),
			'Xinhua Road Sports Center',22000,2009,_country.china,];
    map[_name.zhejiang] = [ClubColors(Colors.green,Colors.green),Coordinates(30.2684601, 120.1288182),
      'Yellow Dragon Sports Center',52672,1998,_country.china,];

    //JAPÃO
    map[_name.albirex] = [ClubColors(Colors.orange,Colors.blue),Coordinates(37.88270153, 139.05925980),
      'Estádio Big Swan',42300,1955,_country.japan,];
    map[_name.avispa] = [ClubColors(Colors.black,Colors.grey),Coordinates(33.5859820, 130.460848),
      'Best Denki Stadium',22563,1982,_country.japan,];
    map[_name.cerezoOsaka] = [ClubColors(Colors.pink,Colors.black),Coordinates(34.61412159, 135.5185547),
			'Estádio Nagai',47000,1957,_country.japan,];
    map[_name.fcTokyo] = [ClubColors(Colors.blue,Colors.red),Coordinates(35.664162, 139.527388),
    ...
    map[_name.jubiloiwata] = [ClubColors(Colors.lightBlueAccent,Colors.blueAccent),Coordinates(34.7434570, 137.970775),
			'Shizuoka Ecopa',50000,1970,_country.japan,];
    map[_name.kashimaantlers] = [ClubColors(Colors.red,Colors.grey),Coordinates(35.992503, 140.64383881),
			'Kashima Soccer Stadium',40728,1994,_country.japan,];
    map[_name.kashiwaReysol] = [ClubColors(Colors.yellow,Colors.black),Coordinates(35.8485972, 139.975101733),
    ...
    map[_name.kyoto] = [ClubColors(Colors.purple,Colors.black),Coordinates(35.017214, 135.5850010),
			'Sanga Stadium',21326,1921,_country.japan,];
    map[_name.hiroshima] = [ClubColors(Colors.purple,Colors.white),Coordinates(34.440852708, 132.39482460),
			'Edion Stadium Hiroshima',1938,1938,_country.japan,];
    map[_name.nagoya] = [ClubColors(Colors.red,Colors.orange),Coordinates(35.084593, 137.17108),
			'Estádio de Toyota',45000,1939,_country.japan,];
    map[_name.sagantosu] = [ClubColors(Colors.blue,Colors.pink),Coordinates(33.37167358, 130.520184),
    ...
    map[_name.vegaltaSendai] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(38.31913456, 140.88192),
      'Yurtec Stadium Sendai',19694,1988,_country.japan,];
    map[_name.visselkobe] = [ClubColors(Colors.black,Colors.white),Coordinates(34.65734782, 135.1696),
			'Estádio Kobe Wing',30182,1966,_country.japan,];
    map[_name.yokohamaFC] = [ClubColors(Colors.blue,Colors.white),Coordinates(35.46916, 139.603706),
      'Mitsuzawa Stadium',15046,1999,_country.japan,];
    map[_name.yokohamamarinos] = [ClubColors(Colors.red,Colors.blue),Coordinates(35.5102166, 139.60648),
			'Estádio Internacional de Yokohama',72327,1972,_country.japan,];

    //CORÉIA DO SUL
    map[_name.busan] = [ClubColors(Colors.red,Colors.white),Coordinates(35.190186683, 129.05830),
    ...
    map[_name.gangwon] = [ClubColors(Colors.orange,Colors.green),Coordinates(37.7737816, 128.897490),
      'Gangneung Stadium',30000,2008,_country.southKorea,];
    map[_name.gimcheon] = [ClubColors(Colors.red,Colors.black),Coordinates(36.139672, 128.08642078),
      'Gimcheon Stadium',32000,1984,_country.southKorea,];
    map[_name.incheon] = [ClubColors(Colors.blue,Colors.black),Coordinates(37.466183, 126.64357953),
			'Incheon Football Stadium',20891,2003,_country.southKorea,];
    map[_name.jeonbuk] = [ClubColors(Colors.green,Colors.white),Coordinates(35.8683430, 127.064329),
			'Jeonju World Cup Stadium',42477,1994,_country.southKorea,];
    map[_name.jeju] = [ClubColors(Colors.orange,Colors.red),Coordinates(33.24632024, 126.509235),
      'Jeju World Cup Stadium',35657,1982,_country.southKorea,];
    map[_name.pohang] = [ClubColors(Colors.grey,Colors.black),Coordinates(36.0088520, 129.363788),
			'Pohang Steel Yard',25000,1973,_country.southKorea,];
    map[_name.fcseoul] = [ClubColors(Colors.red,Colors.black),Coordinates(37.56837781, 126.897502),
    ...
    map[_name.bangkok] = [ClubColors(Colors.red,Colors.black),Coordinates(14.06813405, 100.599042),
			'Thammasat Stadium',25000,1988,_country.thailand,];
    map[_name.buriram] = [ClubColors(Colors.blue,Colors.black),Coordinates(14.96592429, 103.0944633),
			'New i-mobile Stadium',32600,1970,_country.thailand,];
    map[_name.pathum] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(14.00078645, 100.679328),
			'Leo Stadium',10114,2006,_country.thailand,];
    map[_name.policeTero] = [ClubColors(Colors.red,Colors.black),Coordinates(13.86733613, 100.578051),
    ...
    map[_name.chennaiyin] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(13.0858151, 80.271831),
			'Jawaharlal Nehru',40000,2014,_country.india,];
    map[_name.eastBengal] = [ClubColors(Colors.red,Colors.yellow),Coordinates(22.55947727, 88.3438917),
      'East Bengal Ground',23500,1920,_country.india,];
    map[_name.goa] = [ClubColors(Colors.orange,Colors.blue),Coordinates(15.28948422, 73.962551),
    ...
    map[_name.kerala] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(13.08564797, 80.2716407),
			'Jawaharlal Nehru',75000,2014,_country.india,];
    map[_name.mohunBagan] = [ClubColors(Colors.lightBlueAccent,Colors.yellow),Coordinates(22.5622357, 88.34235),
      'Mohun Bagan Ground',20000,2020,_country.india,];
    map[_name.mumbai] = [ClubColors(Colors.lightBlueAccent,Colors.yellow),Coordinates(19.042204573, 73.0269),
			'DY Patil Stadium',55000,2014,_country.india,];
    map[_name.northeast] = [ClubColors(Colors.lightBlueAccent,Colors.yellow),Coordinates(26.115528, 91.760329),
    ...
    //BANGLADESH
    map[_name.bashundhara] = [ClubColors(Colors.red,Colors.white),Coordinates(25.93206572, 88.845353167),
      'Estádio Sheikh Kamal',21359,2013,_country.bangladesh,];
    map[_name.dhakaAbahani] = [ClubColors(Colors.blue,Colors.blue),Coordinates(23.72791777, 90.4135417),
      'Bangabandhu National Stadium',60000,1972,_country.bangladesh,];
    map[_name.saif] = [ClubColors(Colors.yellow,Colors.black),Coordinates(23.54811565, 90.5364364),
      'Munshigonj District Stadium',10000,2016,_country.bangladesh,];
    map[_name.sheikhJamal] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(23.5477248, 90.53690),
      'Munshigonj District Stadium',10000,1962,_country.bangladesh,];
    //INDONESIA
    map[_name.bali] = [ClubColors(Colors.red,Colors.black),Coordinates(-8.5468398, 115.3064336),
      'Kapten I Wayan Dipta',18000,2015,_country.indonesia,];
    map[_name.borneo] = [ClubColors(Colors.red,Colors.black),Coordinates(-0.49305867, 117.14939),
      'Segiri Stadium',16000,2014,_country.indonesia,];
    map[_name.persib] = [ClubColors(Colors.blue,Colors.white),Coordinates(-6.957815877, 107.712158),
    ...
    map[_name.persipura] = [ClubColors(Colors.red,Colors.black),Coordinates(-2.5790803, 140.57361),
			'Lukas Enembe',40263,1963,_country.indonesia,];
    //MONGOLIA
    map[_name.athletic220] = [ClubColors(Colors.blue,Colors.white),Coordinates(47.900222, 106.916315),
      'MFF Football Centre',5000,2016,_country.mongolia,];
    map[_name.erchim] = [ClubColors(Colors.yellow,Colors.red),Coordinates(47.888914, 106.79751),
      'Erchim Stadium',2000,1994,_country.mongolia,];
    map[_name.khoromkhon] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(47.9022031, 106.91699),
      'MFF Football Centre',5000,1999,_country.mongolia,];
    map[_name.ulaanbaatar] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(47.8013018, 106.744977),
    ...
    //PHILIPPINNES
    map[_name.maharlikaManila] = [ClubColors(Colors.black,Colors.purple),Coordinates(14.563410, 120.9921828),
    ...
    //MALAYSIA
    map[_name.johorDarul] = [ClubColors(Colors.blue,Colors.red),Coordinates(1.497541866, 103.751479),
      'Larkin Stadium',30000,1970,_country.malaysia,];
    map[_name.kedah] = [ClubColors(Colors.yellow,Colors.green),Coordinates(6.135977965, 100.3716979),
      '	Darul Aman Stadium',32387,1924,_country.malaysia,];
    map[_name.kualaLumpur] = [ClubColors(Colors.red,Colors.white),Coordinates(3.10071364, 101.721440),
      'Kuala Lumpur Stadium',18000,1974,_country.malaysia,];
    map[_name.selangor] = [ClubColors(Colors.red,Colors.yellow),Coordinates(3.08214134, 101.54496),
      'Our Tampines Hub',80372,1905,_country.malaysia,];
    //SINGAPORE
    map[_name.warriors] = [ClubColors(Colors.blue,Colors.red),Coordinates(1.391140, 103.74921),
      'Choa Chu Kang Stadium',10000,1975,_country.singapore,];
    map[_name.tampines] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(1.3528877, 103.940622),
      'Our Tampines Hub',5000,1945,_country.singapore,];
    //BRUNEI
    map[_name.brunei] = [ClubColors(Colors.red,Colors.black),Coordinates(1.35453962, 103.851562),
    ...
    //UAE
    map[_name.ajman] = [ClubColors(Colors.orange,Colors.white),Coordinates(25.392500, 55.450728),
      'Estádio Ajman',5537,1974,_country.uae,];
    map[_name.alain] = [ClubColors(Colors.purple,Colors.white),Coordinates(24.245059, 55.7170932),
    ...
    map[_name.alnasrdubai] = [ClubColors(Colors.blue,Colors.white),Coordinates(25.23990846, 55.312893),
      'Al Maktoum Stadium',15058,1945,_country.uae,];
    map[_name.alsharjah] = [ClubColors(Colors.white,Colors.red),Coordinates(25.3332735, 55.4195766),
      'Sharjah Stadium',10000,1966,_country.uae,];
    map[_name.alWahda] = [ClubColors(grena,Colors.white),Coordinates(24.469883556, 54.3753338),
			'Estádio Al Nahyan',12000,1974,_country.uae,];
    map[_name.alwasl] = [ClubColors(Colors.yellow,Colors.yellow),Coordinates(25.219131, 55.3169737),
      'Zabeel Stadium',18000,1960,_country.uae,];
    map[_name.baniyas] = [ClubColors(Colors.yellow,Colors.yellow),Coordinates(24.34986, 54.68571),
      'Baniyas Stadium',9047,1974,_country.uae,];
    map[_name.shababalahli] = [ClubColors(Colors.red,Colors.green),Coordinates(25.279691, 55.3607072),
    ...
    map[_name.alMuharraq] = [ClubColors(Colors.red,Colors.white),Coordinates(26.25750173, 50.62779),
      'Al Muharraq Stadium',20000,1928,_country.bahrein,];
    map[_name.alRiffa] = [ClubColors(Colors.blue,Colors.white),Coordinates(26.1528, 50.542743),
      'Bahrain National Stadium',24000,1953,_country.bahrein,];
    map[_name.manama] = [ClubColors(Colors.blue,Colors.red),Coordinates(26.1535, 50.54359),
      'Bahrain National Stadium',24000,1946,_country.bahrein,];
    //SOUTH ARABIA
    map[_name.alahli] = [ClubColors(Colors.green,Colors.white),Coordinates(21.446627355, 39.2523386),
      'Prince Abdullah al-Faisal Stadium',27000,1937,_country.southArabia,];
    map[_name.alettifaq] = [ClubColors(Colors.red,Colors.grey),Coordinates(26.426514, 50.114128),
      'Prince Mohamed bin Fahd Stadium',26000,1945,_country.southArabia,];
    map[_name.alfateh] = [ClubColors(Colors.blue,Colors.green),Coordinates(25.305669, 49.61340246),
      'Prince Abdullah bin Jalawi Stadium',19550,1958,_country.southArabia,];
    map[_name.alhilal] = [ClubColors(Colors.blue,Colors.white),Coordinates(24.78903170, 46.8395937),
			'King Fahd Stadium',67000,1957,_country.southArabia,];
    map[_name.alIttihad] = [ClubColors(Colors.yellow,Colors.black),Coordinates(21.44662735, 39.2524137),
      'Prince Abdullah Al-Faisal Stadium',27000,1927,_country.southArabia,];
    map[_name.alnassr] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(21.76355015, 39.164367968),
			'Universitário Rei Saud',25000,1955,_country.southArabia,];
    map[_name.alraed] = [ClubColors(Colors.red,Colors.grey),Coordinates(26.3795, 43.948),
      'King Abdullah Sports City Stadium',30000,1954,_country.southArabia,];
    map[_name.alShabab] = [ClubColors(Colors.white,Colors.orange),Coordinates(24.78829136, 46.839111),
      'Estádio Internacional Rei Fahd',75000,1947,_country.southArabia,];
    map[_name.altaawoun] = [ClubColors(Colors.yellow,darkblue),Coordinates(26.37901905, 43.9477167),
      'King Abdullah Sport City Stadium',25000,1956,_country.southArabia,];
    map[_name.damac] = [ClubColors(Colors.red,Colors.yellow),Coordinates(18.3105417, 42.597956),
    ...
    map[_name.alAnsar] = [ClubColors(Colors.green,Colors.white),Coordinates(33.8384684, 35.495880),
    ...
    //AUSTRALIA
    map[_name.adelaide] = [ClubColors(Colors.red,Colors.blue),Coordinates(-34.9074787, 138.56896413),
			'Coopers Stadium',16500,2003,_country.australia,];
    map[_name.brisbane] = [ClubColors(Colors.orange,Colors.black),Coordinates(-27.464607, 153.0096921280),
			'Suncorp Stadium',53223,2005,_country.australia,];
    map[_name.centralcoast] = [ClubColors(Colors.yellow,darkblue),Coordinates(-33.42820, 151.3379147192544),
    ...
    map[_name.almasry] = [ClubColors(Colors.green,Colors.white),Coordinates(31.271395, 32.291329),
      'Porto Said Stadium',18000,1920,_country.egypt,];
    map[_name.cleopatra] = [ClubColors(Colors.red,Colors.black),Coordinates(29.957375, 32.542372),
      'Suez Stadium',27000,2007,_country.egypt,];
    map[_name.future] = [ClubColors(Colors.lightBlueAccent,Colors.black),Coordinates(30.174269, 31.435062),
    ...
    map[_name.maghreb] = [ClubColors(Colors.yellow,Colors.black),Coordinates(34.0028129, -4.96905145),
      'Complexe Sportif de Fès',45000,1946,_country.morocco,];
    //ALGERIA
    map[_name.belouizdad] = [ClubColors(Colors.white,Colors.red),Coordinates(36.7456313, 3.0786813),
    ...
    map[_name.benghazi] = [ClubColors(Colors.red,Colors.white),Coordinates(32.1022578, 20.072776),
      '28 de Março',65000,1950,_country.libya,];
    //TUNISIA
    map[_name.clubAfricain] = [ClubColors(Colors.white,Colors.red),Coordinates(36.839919, 10.185206),
    ...
    //AFRICA NEGRA
    //AFRICA DO SUL
    map[_name.amazulu] = [ClubColors(Colors.green,Colors.white),Coordinates(-29.828736, 31.030474),
    ...
    map[_name.goldenarrows] = [ClubColors(Colors.green,Colors.yellow),Coordinates(-29.824950, 31.029732),
    ...
    map[_name.maritzburg] = [ClubColors(Colors.orange,Colors.black),Coordinates(-29.6175844, 30.3856279),
    ...
    map[_name.sagradaesperanca] = [ClubColors(Colors.white,Colors.green),Coordinates(-7.3883419, 20.8334375),
      'Estádio Sagrada Esperança',8200,1976,_country.angola,];
    map[_name.sptCabinda] = [ClubColors(Colors.green,Colors.white),Coordinates(-5.5079227, 12.240064),
      'Estádio Nacional do Chiazi',20000,1975,_country.angola,];
    //BOTSWANA
    map[_name.gaborone] = [ClubColors(Colors.red,Colors.white),Coordinates(-24.6567388, 25.9327138),
			'Botswana National Stadium',22500,1967,_country.botswana,];
    //CAMEROON
    map[_name.cotonsport] = [ClubColors(Colors.green,Colors.white),Coordinates(9.32640861, 13.3998728),
      'Roumdé Adjia',35000,1986,_country.cameroon,];
    map[_name.canonYaounde] = [ClubColors(Colors.red,Colors.white),Coordinates(3.8855102, 11.54057732),
      'Ahmadou Ahidjo',42500,1930,_country.cameroon,];
    map[_name.douala] = [ClubColors(Colors.red,Colors.white),Coordinates(4.0560857, 9.7187861),
      'Stade de la Réunification',30000,1958,_country.cameroon,];
    //CAPE VERDE
    map[_name.mindelense] = [ClubColors(Colors.orange,Colors.red),Coordinates(16.882555, -24.985470),
      'Estádio Municipal Aderito Sena',5000,1919,_country.capeVerde,];
    map[_name.sptClubePraia] = [ClubColors(Colors.green,Colors.white),Coordinates(14.916149, -23.511936),
      'Estádio da Várzea',8000,1923,_country.capeVerde,];
    //CONGO
    map[_name.diablesNoirs] = [ClubColors(Colors.black,Colors.yellow),Coordinates(-4.27254194, 15.24862744),
      'Stade Alphonse Massemba-Débat',5000,1950,_country.congo,];
    map[_name.otoho] = [ClubColors(Colors.yellow,Colors.blue),Coordinates(0, 0),
      'Complexe Omnisports d’Oyo',1629,2014,_country.congo,];
    map[_name.talangai] = [ClubColors(Colors.black,Colors.black),Coordinates(-4.27341746, 15.2487253),
      'Stade Alphonse Massemba-Débat',33037,1935,_country.congo,];
    //RD CONGO
    map[_name.maniema] = [ClubColors(Colors.green,Colors.black),Coordinates(-4.33021337, 15.310353),
    ...
    map[_name.vita] = [ClubColors(Colors.green,Colors.black),Coordinates(-4.33065248, 15.31034443),
      'Stade des Martyrs',80000,1935,_country.congoRD,];
    //ETHIOPIA
    map[_name.fasil] = [ClubColors(Colors.red,Colors.white),Coordinates(12.618048, 37.45961),
      'Fasiledes Stadium',20000,1968,_country.ethiopia,];
    map[_name.stGeorge] = [ClubColors(Colors.yellow,Colors.red),Coordinates(9.0132947, 38.7565828),
      'Addis Ababa Stadium',24000,1935,_country.ethiopia,];
    //GHANA
    map[_name.asantekotoko] = [ClubColors(Colors.red,Colors.yellow),Coordinates(6.68225260, -1.6050228),
			'Baba Yara Stadium',43000,1935,_country.ghana,];
    map[_name.heartsoak] = [ClubColors(Colors.red,Colors.purple),Coordinates(5.55150373, -0.19180352),
			'Ohene Djan Stadium',40000,1911,_country.ghana,];
    //GUINEA
    map[_name.hafia] = [ClubColors(Colors.green,Colors.white),Coordinates(9.54617954, -13.672815),
			'Stade 28 Septembre',25000,1951,_country.guinea,];
    map[_name.horoya] = [ClubColors(Colors.red,Colors.white),Coordinates(9.5462, -13.6728),
      'Stade 28 Septembre',25000,1975,_country.guinea,];
    //KHENYA
    map[_name.gorMahia] = [ClubColors(Colors.green,Colors.white),Coordinates(-1.294090, 36.842290),
      'City Stadium',15000,1968,_country.kenya,];
    map[_name.mathare] = [ClubColors(Colors.yellow,Colors.yellow),Coordinates(-1.2300765, 36.8924818),
      'Moi International Sports Centre',60000,1994,_country.kenya,];
    map[_name.tusker] = [ClubColors(Colors.yellow,Colors.yellow),Coordinates(-1.2345079, 36.8804135),
      'Ruaraka Stadium',1000,1969,_country.kenya,];
    map[_name.ulinzi] = [ClubColors(Colors.red,Colors.black),Coordinates(-0.2955202, 36.07390),
      'Afraha Stadium',8200,1995,_country.kenya,];
    //MADAGASCAR
    map[_name.adema] = [ClubColors(Colors.blue,Colors.white),Coordinates(-18.15230, 49.4160806),
      'Stade Municipal de Toamasina',2500,1955,_country.madagascar,];
    map[_name.cnapsSport] = [ClubColors(Colors.white,Colors.blue),Coordinates(-18.919411, 47.5259711),
    ...
    //NAMIBIA
    map[_name.blackAfrica] = [ClubColors(Colors.red,Colors.black),Coordinates(-22.5159386, 17.060735),
      'Sam Nujoma Stadium',25000,1986,_country.namibia,];
    map[_name.africanStars] = [ClubColors(Colors.red,Colors.white),Coordinates(-22.5162, 17.060),
    ...
    map[_name.riversUtd] = [ClubColors(Colors.white,Colors.blue),Coordinates(4.96715013, 6.971510),
      'Adokiye Amiesimaka Stadium',38000,2016,_country.nigeria,];
    map[_name.shootingstars] = [ClubColors(Colors.blue,Colors.white),Coordinates(7.39632598, 3.885855),
      'Lekan Salami Stadium',10000,1950,_country.nigeria,];
    map[_name.sunshinestars] = [ClubColors(Colors.orange,Colors.blue),Coordinates(7.25847070, 5.1896354),
      'Akure Township Stadium',5000,1995,_country.nigeria,];
    //IVORY COAST
    map[_name.africaSports] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(6.1192630, -5.9613877),
      'Stade Robert Champroux',15000,1960,_country.ivorycoast];
    map[_name.asecmimosas] = [ClubColors(Colors.green,Colors.red),Coordinates(5.3049676, -3.99280839),
			'Stade Robert Champroux',10000,1947,_country.ivorycoast];
    map[_name.gagnoa] = [ClubColors(Colors.blue,Colors.yellow),Coordinates(6.1192630, -5.9613877),
      'Stade Victor Biaka Boda',15000,1960,_country.ivorycoast];
    map[_name.omnisport] = [ClubColors(Colors.orange,Colors.white),Coordinates(6.8279876, -5.246351),
      'Stade de Yamoussoukro',6000,1932,_country.ivorycoast];
    map[_name.sanPedro] = [ClubColors(Colors.orange,Colors.black),Coordinates(4.7607713, -6.638301),
      'Stade Auguste Denise',8000,2004,_country.ivorycoast];
    //SENEGAL
    map[_name.douanes] = [ClubColors(Colors.blue,Colors.green),Coordinates(14.711, -17.458),
      'Demba Diop',20000,1980,_country.senegal];
    map[_name.genefoot] = [ClubColors(Colors.blue,Colors.green),Coordinates(0,0),
    ...
    //SUDÃO
    map[_name.omdurman] = [ClubColors(Colors.blue,Colors.white),Coordinates(15.6473138, 32.4749635),
      'Al Hilal Stadium',25000,1930,_country.sudan];
    map[_name.almerrikh] = [ClubColors(Colors.red,Colors.yellow),Coordinates(15.64140, 32.471581),
    ...
    //ZAMBIA
    map[_name.greenEagles] = [ClubColors(Colors.blue,Colors.white),Coordinates(-16.8139242, 26.9879751),
      'Choma Independence Stadium',1000,2002,_country.zambia];
    map[_name.nkana] = [ClubColors(Colors.red,Colors.white),Coordinates(-12.847060, 28.2112330),
      'Nkana Stadium',10000,1935,_country.zambia];
    map[_name.zesco] = [ClubColors(Colors.blue,Colors.white),Coordinates(-12.9751432, 28.611562),
    ...
    map[_name.manicaDiamonds] = [ClubColors(Colors.yellow,Colors.black),Coordinates(-18.996833, 32.6409931),
