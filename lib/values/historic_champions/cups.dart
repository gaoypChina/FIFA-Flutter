...
Map<String,dynamic> mapCopas = {
  ...
  leagueName.spainCup : {
    ...
    1959.0: [_name.barcelona,_name.granada,],
    1958.0: [_name.athleticbilbao,_name.realmadrid,],
    1957.0: [_name.barcelona,_name.espanyol,],
    1956.0: [_name.athleticbilbao,_name.atleticomadrid,],
    1955.0: [_name.athleticbilbao,_name.sevilla,],
    1954.0: [_name.valencia,_name.barcelona,],
    1953.0: [_name.barcelona,_name.athleticbilbao,],
    1952.0: [_name.barcelona,_name.valencia,],
    1951.0: [_name.barcelona,_name.realsociedad,],
    1950.0: [_name.athleticbilbao,_name.valladolid,],
    1949.0: [_name.valencia,_name.athleticbilbao,],
    1948.0: [_name.sevilla,_name.celtavigo],
   ...
   leagueName.franceCup : {
    ...
    1959.0: [_name.lehavre,_name.sochaux,],
    1958.0: [_name.reims,_name.nimes,],
    1957.0: [_name.toulouse,_name.angers,],
    1956.0: [_name.sedan,_name.troyes,],
    1955.0: [_name.lille,_name.bordeaux,],
    1954.0: [_name.nice,_name.om,],
    1953.0: [_name.lille,_name.nancy,],
    1952.0: [_name.nice,_name.bordeaux,],
    1951.0: [_name.strasbourg,_name.valenciennes,],
    1950.0: [_name.reims,_name.racingParis,],
    1949.0: [_name.racingParis,_name.lille,],
    1948.0: [_name.lille,_name.lens,],
    1947.0: [_name.lille,_name.strasbourg,],
    1946.0: [_name.lille,_name.redstar,],
  ...
  leagueName.germanyCup : {
    ...
    1959.0: [],
    1958.0: [_name.stuttgart,_name.fortunaDusseldorf,],
    1957.0: [_name.bayernmunique,_name.fortunaDusseldorf,],
    1956.0: [_name.karlsruher,_name.hamburgo,],
    1955.0: [_name.karlsruher,_name.schalke04,],
    1954.0: [_name.stuttgart,_name.colonia,],
    1953.0: [_name.rotWeissEssen,_name.aachen,],
  },
   ...
   leagueName.portugalCup : {
    ...
    1959.0: [_name.benfica,_name.porto,],
    1958.0: [_name.porto,_name.benfica,],
    1957.0: [_name.benfica,_name.covilha,],
    1956.0: [_name.porto,_name.torreense,],
    1955.0: [_name.benfica,_name.sporting,],
    1954.0: [_name.sporting,_name.setubal,],
    1953.0: [_name.benfica,_name.porto,],
    1952.0: [_name.benfica,_name.sporting,],
    1951.0: [_name.benfica,_name.coimbra,],
    1950.0: [],
    1949.0: [_name.benfica,_name.atleticoPT,],
    1948.0: [_name.sporting,_name.belenenses,],
    1947.0: [],
    1946.0: [_name.sporting,_name.atleticoPT],
    1945.0: [_name.sporting,_name.olhanense],
  },
