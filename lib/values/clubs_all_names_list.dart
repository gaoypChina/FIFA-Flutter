...
List clubsAllNameList = [
  ...
  ClubName().toulouse,ClubName().angers,ClubName().lens,
  ...
  ClubName().olympiacos,ClubName().aek,ClubName().paok,ClubName().panathinaikos,
  ClubName().apoel,ClubName().qarabag,ClubName().astana,ClubName().vardar,
