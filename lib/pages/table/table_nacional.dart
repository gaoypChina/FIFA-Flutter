...
Widget matchsWidget(){
    ...
    children: [
      Row(
        children: [
          ...
          GestureDetector(
              onTap:(){
                if(rodadaMatch<League(index: choosenLeagueIndex).getNTeams()-1) {
                  rodadaMatch ++;
                }
                setState(() {});
              },
  ...
  TableRow rowMatches(int numeroDoConfronto) {
    List chave = GlobalFunctions().obterChave(rodadaMatch, choosenLeagueIndex);
    ...
    int chaveClub2 = GlobalFunctions().chaveIndexAdvCampeonato(rodadaMatch, choosenLeagueIndex, chaveClub1)[0];
    String teamName2 = leagueClass.getClubName(chaveClub2);

    late int gol1,gol2;
    if(rodadaMatch<rodada) {
    ...
    return TableRow(
      children: [
        ...
        Image.asset('assets/clubs/${FIFAImages().imageLogo(teamName1)}.png',height: 25,width: 25),
        (rodadaMatch<rodada) ? Text(gol1.toString(),textAlign:TextAlign.center,style: EstiloTextoBranco.text14) : Container(),
        const Text('x',style: EstiloTextoBranco.text16,textAlign: TextAlign.center,),
        (rodadaMatch<rodada) ? Text(gol2.toString(),textAlign:TextAlign.center,style: EstiloTextoBranco.text14) : Container(),
        Image.asset('assets/clubs/${FIFAImages().imageLogo(teamName2)}.png',height: 25,width: 25),
