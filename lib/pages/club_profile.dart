...
////////////////////////////////////////////////////////////////////////////
  comprarJogador(Jogador player){
    popUpOkCancelar(
        ...
        content: 'Saldo: \$'+globalMyMoney.toStringAsFixed(2)
            + '\n\nPreço: \$'+player.price.toStringAsFixed(2)
            + '\nOVR: ' + player.overall.toString()
