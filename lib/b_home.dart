...
import 'package:fifa/global/update_data_year.dart';
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children:[
                        ...
                        GestureDetector(
                          onTap: (){
                            int clubID = League(index: indexLeague).getClubIndex(posicao);
                          ...
                          child: SizedBox(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(GlobalFunctions().getDificuldadeNome(),style: EstiloTextoBranco.underline14),
                              ],
                            ),
                          ),
                        ),
...
////////////////////////////////////////////////////////////////////////////
  saveMyData(){
    GlobalFunctions().changeTeam(teamName,indexLeague,posicao);
  }
      ...
      for(int team=0;team<16;team++) {
        ...
        try {
          ...
          if (name.isNotEmpty && position.isNotEmpty && age > 10) {
            ...
            //VARIAVEIS GLOBAIS
            int clubIndex = GlobalFunctions().getClubIndexFromName(club);
