...
class Classification{
  ...
  setClassification(){
    globalLeagueClassification = {};

    for (int i = 0; i <leaguesListRealIndex.length; i++) {
      int leagueID = leaguesListRealIndex[i];
      List leagueClassificationList = setClassification1League(leagueID);
      globalLeagueClassification[leagueID] = leagueClassificationList;
    }
  }
  List setClassification1League(int leagueIndex) {
    ...
    for (int i = 0; i <nClubs; i++) {
      int clubIndex = ligaClass.getClubIndex(i);
